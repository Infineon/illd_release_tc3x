...
{
    Ifx_UReg_32Bit APF:2;             /**< \brief [1:0] Access Protection Fast Compare Channels (rw) */
...
typedef volatile struct _Ifx_EVADC
{
       ...
       Ifx_EVADC_FC                        FC[2];                  /**< \brief 3400, */
       Ifx_UReg_8Bit                       reserved_3600[2560];    /**< \brief 3600, \internal Reserved */
} Ifx_EVADC;
