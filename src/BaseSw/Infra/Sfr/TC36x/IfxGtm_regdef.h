...
{
       Ifx_GTM_AUX_IN_SRC_TIM              TIM[3];                 /**< \brief 0, GTM TIM ${i} Module AUX_IN Source Selection Register*/
} Ifx_GTM_AUX_IN_SRC;
/** \}  */
/******************************************************************************/
/** \}  */
...
typedef volatile struct _Ifx_GTM_MON_ACTIVITY
{
       ...
       Ifx_GTM_MON_ACTIVITY_MCS            MCS[3];                 /**< \brief 8, Monitor Activity Register for MCS ${z}*/
...
typedef volatile struct _Ifx_GTM_MON
{
       ...
       Ifx_UReg_8Bit                       reserved_18[28];        /**< \brief 18, \internal Reserved */
} Ifx_GTM_MON;
/** \}  */
/******************************************************************************/
/** \}  */
...
typedef volatile struct _Ifx_GTM_ICM_IRQG
{
       ...
       Ifx_UReg_8Bit                       reserved_44[32];        /**< \brief 44, \internal Reserved */
       Ifx_GTM_ICM_IRQG_CEI_MCS            CEI_MCS[3];             /**< \brief 64, ICM Interrupt Group MCS ${i} for Channel Error Interrupt information*/
       Ifx_UReg_8Bit                       reserved_70[52];        /**< \brief 70, \internal Reserved */
       ...
       Ifx_UReg_8Bit                       reserved_114[12];       /**< \brief 114, \internal Reserved */
       Ifx_GTM_ICM_IRQG_CI_MCS             CI_MCS[3];              /**< \brief 120, ICM Interrupt Group MCS ${i} for Channel Interrupt Information*/
       Ifx_UReg_8Bit                       reserved_12C[52];       /**< \brief 12C, \internal Reserved */
...
typedef volatile struct _Ifx_GTM_DPLL
{
       ...
       Ifx_UReg_32Bit                             RR2[1024];              /**< \brief 4000, RAM based TRIGGER data*/
...
typedef volatile struct _Ifx_GTM_MSC
{
       ...
       Ifx_GTM_MSC_MSCQ                    MSCQ[1];                /**< \brief 90, MSC${i} Input Low Extended Control Register*/
} Ifx_GTM_MSC;
/** \}  */
/******************************************************************************/
/** \}  */
...
typedef volatile struct _Ifx_GTM
{
       ...
       Ifx_UReg_8Bit                       reserved_4C[16];        /**< \brief 4C, \internal Reserved */
       Ifx_GTM_EXT_CAP_EN                  EXT_CAP_EN[3];          /**< \brief 5C, GTM External Capture Trigger Enable ${i}*/
       ...
       Ifx_GTM_TIM                         TIM[3];                 /**< \brief 1000, */
       Ifx_UReg_8Bit                       reserved_2800[22528];    /**< \brief 2800, \internal Reserved */
       Ifx_GTM_TOM                         TOM[2];                 /**< \brief 8000, */
       Ifx_UReg_8Bit                       reserved_9000[61440];    /**< \brief 9000, \internal Reserved */
       ...
       Ifx_GTM_TIMINSEL                    TIMINSEL[3];            /**< \brief 9FD40, TIM${n} Input Select Register*/
       Ifx_UReg_8Bit                       reserved_9FD4C[20];     /**< \brief 9FD4C, \internal Reserved */
       Ifx_GTM_TOUTSEL                     TOUTSEL[17];            /**< \brief 9FD60, Timer Output Select Register*/
       Ifx_UReg_8Bit                       reserved_9FDA4[92];     /**< \brief 9FDA4, \internal Reserved */
       Ifx_GTM_DSADCINSEL                  DSADCINSEL[3];          /**< \brief 9FE00, DSADC Input Select i Register*/
       Ifx_UReg_8Bit                       reserved_9FE0C[20];     /**< \brief 9FE0C, \internal Reserved */
       ...
       Ifx_GTM_TRIGOUT                     TRIGOUT[3];             /**< \brief 9FE74, Trigger Output Register ${n}*/
       Ifx_UReg_8Bit                       reserved_9FE80[28];     /**< \brief 9FE80, \internal Reserved */
       Ifx_GTM_INTOUT                      INTOUT[3];              /**< \brief 9FE9C, Interrupt Output Register ${n}*/
       Ifx_UReg_8Bit                       reserved_9FEA8[28];     /**< \brief 9FEA8, \internal Reserved */
       ...
       Ifx_GTM_DATAIN                      DATAIN[3];              /**< \brief 9FED4, Data Input ${n} Register*/
       Ifx_UReg_8Bit                       reserved_9FEE0[32];     /**< \brief 9FEE0, \internal Reserved */
       Ifx_GTM_MSC                         MSC;                    /**< \brief 9FF00, */
       Ifx_UReg_8Bit                       reserved_9FF9C[48];     /**< \brief 9FF9C, \internal Reserved */
       ...
       Ifx_GTM_CCM                         CCM[4];                 /**< \brief E2000, */
       Ifx_UReg_8Bit                       reserved_E2800[6144];    /**< \brief E2800, \internal Reserved */
       Ifx_GTM_CDTM                        CDTM[4];                /**< \brief E4000, */
       Ifx_UReg_8Bit                       reserved_E5000[12288];    /**< \brief E5000, \internal Reserved */
       Ifx_GTM_ATOM                        ATOM[4];                /**< \brief E8000, */
       Ifx_UReg_8Bit                       reserved_EA000[24576];    /**< \brief EA000, \internal Reserved */
       Ifx_GTM_MCS                         MCS[3];                 /**< \brief F0000, */
       Ifx_UReg_8Bit                       reserved_F3000[53248];    /**< \brief F3000, \internal Reserved */
} Ifx_GTM;
