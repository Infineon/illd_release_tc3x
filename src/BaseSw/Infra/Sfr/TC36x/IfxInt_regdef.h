...
typedef volatile struct _Ifx_INT
{
       ...
       Ifx_INT_ACCEN_SRC                   ACCEN_SRC[3];           /**< \brief 180, Access Enable covering all SRCx[31:16] mapped to ICU${x}, Register 1*/
       Ifx_UReg_8Bit                       reserved_198[104];      /**< \brief 198, \internal Reserved */
       Ifx_INT_CH                          CH[3];                  /**< \brief 200, */
       Ifx_UReg_8Bit                       reserved_230[3536];     /**< \brief 230, \internal Reserved */
} Ifx_INT;
