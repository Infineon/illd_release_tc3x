...
typedef volatile struct _Ifx_INT
{
       ...
       Ifx_UReg_8Bit                       reserved_C[4];          /**< \brief C, \internal Reserved */
       Ifx_INT_SRB                         SRB[2];                 /**< \brief 10, Service Request Broadcast Register ${x}*/
       Ifx_UReg_8Bit                       reserved_18[104];       /**< \brief 18, \internal Reserved */
       ...
       Ifx_INT_ACCEN                       ACCEN[2];               /**< \brief 100, Access Enable covering SRB${x}, Register 1*/
       Ifx_UReg_8Bit                       reserved_110[112];      /**< \brief 110, \internal Reserved */
       Ifx_INT_ACCEN_SRC                   ACCEN_SRC[1];           /**< \brief 180, Access Enable covering all SRCx[31:16] mapped to ICU${x}, Register 1*/
       Ifx_UReg_8Bit                       reserved_188[120];      /**< \brief 188, \internal Reserved */
       Ifx_INT_CH                          CH[1];                  /**< \brief 200, */
       Ifx_UReg_8Bit                       reserved_210[3568];     /**< \brief 210, \internal Reserved */
} Ifx_INT;
