...
#define IFX_EVADC_ACCPROT0_APCP_LEN (2u)

/** \brief Mask for Ifx_EVADC_ACCPROT0_Bits.APCP */
#define IFX_EVADC_ACCPROT0_APCP_MSK (0x3u)
...
#define IFX_EVADC_ACCPROT0_APCS_LEN (2u)

/** \brief Mask for Ifx_EVADC_ACCPROT0_Bits.APCS */
#define IFX_EVADC_ACCPROT0_APCS_MSK (0x3u)
...
#define IFX_EVADC_ACCPROT0_APIP_LEN (2u)

/** \brief Mask for Ifx_EVADC_ACCPROT0_Bits.APIP */
#define IFX_EVADC_ACCPROT0_APIP_MSK (0x3u)
...
#define IFX_EVADC_ACCPROT0_APIS_LEN (2u)

/** \brief Mask for Ifx_EVADC_ACCPROT0_Bits.APIS */
#define IFX_EVADC_ACCPROT0_APIS_MSK (0x3u)
...
#define IFX_EVADC_ACCPROT1_APSP_LEN (2u)

/** \brief Mask for Ifx_EVADC_ACCPROT1_Bits.APSP */
#define IFX_EVADC_ACCPROT1_APSP_MSK (0x3u)
...
#define IFX_EVADC_ACCPROT1_APSS_LEN (2u)

/** \brief Mask for Ifx_EVADC_ACCPROT1_Bits.APSS */
#define IFX_EVADC_ACCPROT1_APSS_MSK (0x3u)
...
#define IFX_EVADC_ACCPROT1_APRP_LEN (2u)

/** \brief Mask for Ifx_EVADC_ACCPROT1_Bits.APRP */
#define IFX_EVADC_ACCPROT1_APRP_MSK (0x3u)
...
#define IFX_EVADC_ACCPROT1_APRS_LEN (2u)

/** \brief Mask for Ifx_EVADC_ACCPROT1_Bits.APRS */
#define IFX_EVADC_ACCPROT1_APRS_MSK (0x3u)
...
#define IFX_EVADC_GLOB_TE_TFEP_LEN (2u)

/** \brief Mask for Ifx_EVADC_GLOB_TE_Bits.TFEP */
#define IFX_EVADC_GLOB_TE_TFEP_MSK (0x3u)
...
#define IFX_EVADC_GLOB_TE_TFES_LEN (2u)

/** \brief Mask for Ifx_EVADC_GLOB_TE_Bits.TFES */
#define IFX_EVADC_GLOB_TE_TFES_MSK (0x3u)
