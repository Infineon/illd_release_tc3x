...
/** \brief Length for Ifx_MTU_MEMMAP_Bits.MEM5MAP */
#define IFX_MTU_MEMMAP_MEM5MAP_LEN (1u)

/** \brief Mask for Ifx_MTU_MEMMAP_Bits.MEM5MAP */
#define IFX_MTU_MEMMAP_MEM5MAP_MSK (0x1u)

/** \brief Offset for Ifx_MTU_MEMMAP_Bits.MEM5MAP */
#define IFX_MTU_MEMMAP_MEM5MAP_OFF (5u)

/** \brief Length for Ifx_MTU_MEMMAP_Bits.MEM6MAP */
#define IFX_MTU_MEMMAP_MEM6MAP_LEN (1u)

/** \brief Mask for Ifx_MTU_MEMMAP_Bits.MEM6MAP */
#define IFX_MTU_MEMMAP_MEM6MAP_MSK (0x1u)

/** \brief Offset for Ifx_MTU_MEMMAP_Bits.MEM6MAP */
#define IFX_MTU_MEMMAP_MEM6MAP_OFF (6u)

/** \brief Length for Ifx_MTU_MEMMAP_Bits.MEM7MAP */
#define IFX_MTU_MEMMAP_MEM7MAP_LEN (1u)

/** \brief Mask for Ifx_MTU_MEMMAP_Bits.MEM7MAP */
#define IFX_MTU_MEMMAP_MEM7MAP_MSK (0x1u)

/** \brief Offset for Ifx_MTU_MEMMAP_Bits.MEM7MAP */
#define IFX_MTU_MEMMAP_MEM7MAP_OFF (7u)

/** \brief Length for Ifx_MTU_MEMMAP_Bits.MEM8MAP */
#define IFX_MTU_MEMMAP_MEM8MAP_LEN (1u)

/** \brief Mask for Ifx_MTU_MEMMAP_Bits.MEM8MAP */
#define IFX_MTU_MEMMAP_MEM8MAP_MSK (0x1u)

/** \brief Offset for Ifx_MTU_MEMMAP_Bits.MEM8MAP */
#define IFX_MTU_MEMMAP_MEM8MAP_OFF (8u)

/** \brief Length for Ifx_MTU_MEMMAP_Bits.MEM10MAP */
#define IFX_MTU_MEMMAP_MEM10MAP_LEN (1u)

/** \brief Mask for Ifx_MTU_MEMMAP_Bits.MEM10MAP */
#define IFX_MTU_MEMMAP_MEM10MAP_MSK (0x1u)

/** \brief Offset for Ifx_MTU_MEMMAP_Bits.MEM10MAP */
#define IFX_MTU_MEMMAP_MEM10MAP_OFF (10u)

/** \brief Length for Ifx_MTU_MEMMAP_Bits.MEM11MAP */
#define IFX_MTU_MEMMAP_MEM11MAP_LEN (1u)

/** \brief Mask for Ifx_MTU_MEMMAP_Bits.MEM11MAP */
#define IFX_MTU_MEMMAP_MEM11MAP_MSK (0x1u)

/** \brief Offset for Ifx_MTU_MEMMAP_Bits.MEM11MAP */
#define IFX_MTU_MEMMAP_MEM11MAP_OFF (11u)

/** \brief Length for Ifx_MTU_MEMMAP_Bits.MEM12MAP */
#define IFX_MTU_MEMMAP_MEM12MAP_LEN (1u)

/** \brief Mask for Ifx_MTU_MEMMAP_Bits.MEM12MAP */
#define IFX_MTU_MEMMAP_MEM12MAP_MSK (0x1u)

/** \brief Offset for Ifx_MTU_MEMMAP_Bits.MEM12MAP */
#define IFX_MTU_MEMMAP_MEM12MAP_OFF (12u)

/** \brief Length for Ifx_MTU_MEMMAP_Bits.MEM13MAP */
#define IFX_MTU_MEMMAP_MEM13MAP_LEN (1u)

/** \brief Mask for Ifx_MTU_MEMMAP_Bits.MEM13MAP */
#define IFX_MTU_MEMMAP_MEM13MAP_MSK (0x1u)

/** \brief Offset for Ifx_MTU_MEMMAP_Bits.MEM13MAP */
#define IFX_MTU_MEMMAP_MEM13MAP_OFF (13u)
