...
typedef volatile struct _Ifx_SENT
{
       ...
       Ifx_SENT_RDR                        RDR[6];                 /**< \brief 80, Receive Data Register ${x}*/
       Ifx_UReg_8Bit                       reserved_98[80];        /**< \brief 98, \internal Reserved */
       ...
       Ifx_SENT_CH                         CH[6];                  /**< \brief 100, Reserved*/
       Ifx_UReg_8Bit                       reserved_280[2048];     /**< \brief 280, \internal Reserved */
       Ifx_SENT_RTS                        RTS[6];                 /**< \brief A80, Receive Time Stamp Register ${x}*/
       Ifx_UReg_8Bit                       reserved_A98[104];      /**< \brief A98, \internal Reserved */
} Ifx_SENT;
