...
/** \brief Length for Ifx_EDSADC_GLOBRC_Bits.CH10RUN */
#define IFX_EDSADC_GLOBRC_CH10RUN_LEN (1u)

/** \brief Mask for Ifx_EDSADC_GLOBRC_Bits.CH10RUN */
#define IFX_EDSADC_GLOBRC_CH10RUN_MSK (0x1u)

/** \brief Offset for Ifx_EDSADC_GLOBRC_Bits.CH10RUN */
#define IFX_EDSADC_GLOBRC_CH10RUN_OFF (10u)

/** \brief Length for Ifx_EDSADC_GLOBRC_Bits.CH11RUN */
#define IFX_EDSADC_GLOBRC_CH11RUN_LEN (1u)

/** \brief Mask for Ifx_EDSADC_GLOBRC_Bits.CH11RUN */
#define IFX_EDSADC_GLOBRC_CH11RUN_MSK (0x1u)

/** \brief Offset for Ifx_EDSADC_GLOBRC_Bits.CH11RUN */
#define IFX_EDSADC_GLOBRC_CH11RUN_OFF (11u)

/** \brief Length for Ifx_EDSADC_GLOBRC_Bits.CH12RUN */
#define IFX_EDSADC_GLOBRC_CH12RUN_LEN (1u)

/** \brief Mask for Ifx_EDSADC_GLOBRC_Bits.CH12RUN */
#define IFX_EDSADC_GLOBRC_CH12RUN_MSK (0x1u)

/** \brief Offset for Ifx_EDSADC_GLOBRC_Bits.CH12RUN */
#define IFX_EDSADC_GLOBRC_CH12RUN_OFF (12u)

/** \brief Length for Ifx_EDSADC_GLOBRC_Bits.CH13RUN */
#define IFX_EDSADC_GLOBRC_CH13RUN_LEN (1u)

/** \brief Mask for Ifx_EDSADC_GLOBRC_Bits.CH13RUN */
#define IFX_EDSADC_GLOBRC_CH13RUN_MSK (0x1u)

/** \brief Offset for Ifx_EDSADC_GLOBRC_Bits.CH13RUN */
#define IFX_EDSADC_GLOBRC_CH13RUN_OFF (13u)
...
/** \brief Length for Ifx_EDSADC_GLOBRC_Bits.M10RUN */
#define IFX_EDSADC_GLOBRC_M10RUN_LEN (1u)

/** \brief Mask for Ifx_EDSADC_GLOBRC_Bits.M10RUN */
#define IFX_EDSADC_GLOBRC_M10RUN_MSK (0x1u)

/** \brief Offset for Ifx_EDSADC_GLOBRC_Bits.M10RUN */
#define IFX_EDSADC_GLOBRC_M10RUN_OFF (26u)

/** \brief Length for Ifx_EDSADC_GLOBRC_Bits.M11RUN */
#define IFX_EDSADC_GLOBRC_M11RUN_LEN (1u)

/** \brief Mask for Ifx_EDSADC_GLOBRC_Bits.M11RUN */
#define IFX_EDSADC_GLOBRC_M11RUN_MSK (0x1u)

/** \brief Offset for Ifx_EDSADC_GLOBRC_Bits.M11RUN */
#define IFX_EDSADC_GLOBRC_M11RUN_OFF (27u)

/** \brief Length for Ifx_EDSADC_GLOBRC_Bits.M12RUN */
#define IFX_EDSADC_GLOBRC_M12RUN_LEN (1u)

/** \brief Mask for Ifx_EDSADC_GLOBRC_Bits.M12RUN */
#define IFX_EDSADC_GLOBRC_M12RUN_MSK (0x1u)

/** \brief Offset for Ifx_EDSADC_GLOBRC_Bits.M12RUN */
#define IFX_EDSADC_GLOBRC_M12RUN_OFF (28u)

/** \brief Length for Ifx_EDSADC_GLOBRC_Bits.M13RUN */
#define IFX_EDSADC_GLOBRC_M13RUN_LEN (1u)

/** \brief Mask for Ifx_EDSADC_GLOBRC_Bits.M13RUN */
#define IFX_EDSADC_GLOBRC_M13RUN_MSK (0x1u)

/** \brief Offset for Ifx_EDSADC_GLOBRC_Bits.M13RUN */
#define IFX_EDSADC_GLOBRC_M13RUN_OFF (29u)
