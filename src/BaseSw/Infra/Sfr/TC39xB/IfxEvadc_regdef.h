...
{
    Ifx_UReg_32Bit APF:8;             /**< \brief [7:0] Access Protection Fast Compare Channels (rw) */
...
typedef volatile struct _Ifx_EVADC
{
       ...
       Ifx_EVADC_FC                        FC[8];                  /**< \brief 3400, */
       Ifx_UReg_8Bit                       reserved_3C00[1024];    /**< \brief 3C00, \internal Reserved */
} Ifx_EVADC;
