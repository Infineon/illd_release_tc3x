...
/** \brief Length for Ifx_DMU_HF_STATUS_Bits.P4BUSY */
#define IFX_DMU_HF_STATUS_P4BUSY_LEN (1u)

/** \brief Mask for Ifx_DMU_HF_STATUS_Bits.P4BUSY */
#define IFX_DMU_HF_STATUS_P4BUSY_MSK (0x1u)

/** \brief Offset for Ifx_DMU_HF_STATUS_Bits.P4BUSY */
#define IFX_DMU_HF_STATUS_P4BUSY_OFF (6u)

/** \brief Length for Ifx_DMU_HF_STATUS_Bits.P5BUSY */
#define IFX_DMU_HF_STATUS_P5BUSY_LEN (1u)

/** \brief Mask for Ifx_DMU_HF_STATUS_Bits.P5BUSY */
#define IFX_DMU_HF_STATUS_P5BUSY_MSK (0x1u)

/** \brief Offset for Ifx_DMU_HF_STATUS_Bits.P5BUSY */
#define IFX_DMU_HF_STATUS_P5BUSY_OFF (7u)
...
/** \brief Length for Ifx_DMU_HF_PROTECT_Bits.PRODISP4 */
#define IFX_DMU_HF_PROTECT_PRODISP4_LEN (1u)

/** \brief Mask for Ifx_DMU_HF_PROTECT_Bits.PRODISP4 */
#define IFX_DMU_HF_PROTECT_PRODISP4_MSK (0x1u)

/** \brief Offset for Ifx_DMU_HF_PROTECT_Bits.PRODISP4 */
#define IFX_DMU_HF_PROTECT_PRODISP4_OFF (12u)

/** \brief Length for Ifx_DMU_HF_PROTECT_Bits.PRODISP5 */
#define IFX_DMU_HF_PROTECT_PRODISP5_LEN (1u)

/** \brief Mask for Ifx_DMU_HF_PROTECT_Bits.PRODISP5 */
#define IFX_DMU_HF_PROTECT_PRODISP5_MSK (0x1u)

/** \brief Offset for Ifx_DMU_HF_PROTECT_Bits.PRODISP5 */
#define IFX_DMU_HF_PROTECT_PRODISP5_OFF (13u)
...
/** \brief Length for Ifx_DMU_HF_PROCONTP_Bits.CPU4DDIS */
#define IFX_DMU_HF_PROCONTP_CPU4DDIS_LEN (1u)

/** \brief Mask for Ifx_DMU_HF_PROCONTP_Bits.CPU4DDIS */
#define IFX_DMU_HF_PROCONTP_CPU4DDIS_MSK (0x1u)

/** \brief Offset for Ifx_DMU_HF_PROCONTP_Bits.CPU4DDIS */
#define IFX_DMU_HF_PROCONTP_CPU4DDIS_OFF (22u)

/** \brief Length for Ifx_DMU_HF_PROCONTP_Bits.CPU5DDIS */
#define IFX_DMU_HF_PROCONTP_CPU5DDIS_LEN (1u)

/** \brief Mask for Ifx_DMU_HF_PROCONTP_Bits.CPU5DDIS */
#define IFX_DMU_HF_PROCONTP_CPU5DDIS_MSK (0x1u)

/** \brief Offset for Ifx_DMU_HF_PROCONTP_Bits.CPU5DDIS */
#define IFX_DMU_HF_PROCONTP_CPU5DDIS_OFF (23u)
