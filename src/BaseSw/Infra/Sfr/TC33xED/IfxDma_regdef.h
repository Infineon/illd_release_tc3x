...
typedef volatile struct _Ifx_DMA
{
       ...
       Ifx_DMA_HRR                         HRR[64];                /**< \brief 1800, DMA Channel ${c} Resource Partition Register*/
       Ifx_UReg_8Bit                       reserved_1900[256];     /**< \brief 1900, \internal Reserved */
       Ifx_DMA_SUSENR                      SUSENR[64];             /**< \brief 1A00, DMA Channel ${c} Suspend Enable Register*/
       Ifx_UReg_8Bit                       reserved_1B00[256];     /**< \brief 1B00, \internal Reserved */
       Ifx_DMA_SUSACR                      SUSACR[64];             /**< \brief 1C00, DMA Channel ${c} Suspend Acknowledge Register*/
       Ifx_UReg_8Bit                       reserved_1D00[256];     /**< \brief 1D00, \internal Reserved */
       Ifx_DMA_TSR                         TSR[64];                /**< \brief 1E00, DMA Channel ${c} Transaction State Register*/
       Ifx_UReg_8Bit                       reserved_1F00[256];     /**< \brief 1F00, \internal Reserved */
       Ifx_DMA_CH                          CH[64];                 /**< \brief 2000, DMARAM Channel ${c} Control and Status Register*/
       Ifx_UReg_8Bit                       reserved_2800[6144];    /**< \brief 2800, \internal Reserved */
} Ifx_DMA;
