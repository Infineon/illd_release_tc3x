/**
 * \file Ifx_Ssw_CompilersHighTec.h
...
#ifndef IFX_SSW_COMPILERSHIGHTEC_H_
#define IFX_SSW_COMPILERSHIGHTEC_H_
...
#define __Ifx_Ssw_Start(stackPtr, funcPtr) \
    __asm("movh.a %a10, hi:("STRINGIFY(stackPtr)")\n" \
          "\tlea %a10, [%a10]lo:("STRINGIFY(stackPtr)") \n " \
          "\tdsync \n" \
		  "\tmovh.a %a15,  hi:("STRINGIFY(funcPtr)")\n" \
		  "\tlea %a15, [%a15]lo:("STRINGIFY(funcPtr)")\n" \
		  "\tji %a15");
/******************************************************************************/
/*--------------------------------   Typedefs  -------------------------------*/
/******************************************************************************/
...
IFX_SSW_INLINE void Ifx_Ssw_debug(void)
{
...
/*#define Ifx_Ssw_jumpToFunction(fun) \
  __asm("movh.a %a15, hi:(" #fun ")\n" \
        "lea %a15, [%a15]lo:(" #fun ")\n" \
        "ji %a15")*/
...
#endif /* IFX_SSW_COMPILERSHIGHTEC_H_ */
