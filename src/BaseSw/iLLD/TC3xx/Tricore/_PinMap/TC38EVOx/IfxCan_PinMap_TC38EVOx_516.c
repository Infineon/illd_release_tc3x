/**
 * \file IfxCan_PinMap_TC38EVOx_516.c
 * \brief CAN I/O map
 * \ingroup IfxLld_Can
 *
 * \version iLLD_1_22_0
...
#include "IfxCan_PinMap_TC38EVOx_516.h"
...
IfxCan_Rxd_In IfxCan_RXD30A_P10_4_IN = {&MODULE_CAN3, IfxCan_NodeId_0, {&MODULE_P10, 4}, Ifx_RxSel_a};
IfxCan_Rxd_In IfxCan_RXD30B_P02_8_IN = {&MODULE_CAN3, IfxCan_NodeId_0, {&MODULE_P02, 8}, Ifx_RxSel_b};
IfxCan_Rxd_In IfxCan_RXD31A_P11_13_IN = {&MODULE_CAN3, IfxCan_NodeId_1, {&MODULE_P11,13}, Ifx_RxSel_a};
IfxCan_Rxd_In IfxCan_RXD31B_P33_14_IN = {&MODULE_CAN3, IfxCan_NodeId_1, {&MODULE_P33,14}, Ifx_RxSel_b};
IfxCan_Rxd_In IfxCan_RXD32A_P01_3_IN = {&MODULE_CAN3, IfxCan_NodeId_2, {&MODULE_P01, 3}, Ifx_RxSel_a};
IfxCan_Rxd_In IfxCan_RXD32B_P20_6_IN = {&MODULE_CAN3, IfxCan_NodeId_2, {&MODULE_P20, 6}, Ifx_RxSel_b};
IfxCan_Rxd_In IfxCan_RXD33A_P13_2_IN = {&MODULE_CAN3, IfxCan_NodeId_3, {&MODULE_P13, 2}, Ifx_RxSel_a};
IfxCan_Rxd_In IfxCan_RXD33B_P21_6_IN = {&MODULE_CAN3, IfxCan_NodeId_3, {&MODULE_P21, 6}, Ifx_RxSel_b};
IfxCan_Rxd_In IfxCan_RXD40A_P00_11_IN = {&MODULE_CAN4, IfxCan_NodeId_0, {&MODULE_P00,11}, Ifx_RxSel_a};
IfxCan_Rxd_In IfxCan_RXD40B_P20_1_IN = {&MODULE_CAN4, IfxCan_NodeId_0, {&MODULE_P20, 1}, Ifx_RxSel_b};
IfxCan_Rxd_In IfxCan_RXD41A_P22_2_IN = {&MODULE_CAN4, IfxCan_NodeId_1, {&MODULE_P22, 2}, Ifx_RxSel_a};
IfxCan_Rxd_In IfxCan_RXD41B_P14_0_IN = {&MODULE_CAN4, IfxCan_NodeId_1, {&MODULE_P14, 0}, Ifx_RxSel_b};
IfxCan_Rxd_In IfxCan_RXD42A_P22_5_IN = {&MODULE_CAN4, IfxCan_NodeId_2, {&MODULE_P22, 5}, Ifx_RxSel_a};
IfxCan_Rxd_In IfxCan_RXD42B_P15_4_IN = {&MODULE_CAN4, IfxCan_NodeId_2, {&MODULE_P15, 4}, Ifx_RxSel_b};
IfxCan_Rxd_In IfxCan_RXD43A_P34_3_IN = {&MODULE_CAN4, IfxCan_NodeId_3, {&MODULE_P34, 3}, Ifx_RxSel_a};
IfxCan_Rxd_In IfxCan_RXD43B_P15_7_IN = {&MODULE_CAN4, IfxCan_NodeId_3, {&MODULE_P15, 7}, Ifx_RxSel_b};
...
IfxCan_Txd_Out IfxCan_TXD30_P02_9_OUT = {&MODULE_CAN3, IfxCan_NodeId_0, {&MODULE_P02, 9}, IfxPort_OutputIdx_alt4};
IfxCan_Txd_Out IfxCan_TXD30_P10_0_OUT = {&MODULE_CAN3, IfxCan_NodeId_0, {&MODULE_P10, 0}, IfxPort_OutputIdx_alt4};
IfxCan_Txd_Out IfxCan_TXD31_P10_3_OUT = {&MODULE_CAN3, IfxCan_NodeId_1, {&MODULE_P10, 3}, IfxPort_OutputIdx_alt2};
IfxCan_Txd_Out IfxCan_TXD31_P33_15_OUT = {&MODULE_CAN3, IfxCan_NodeId_1, {&MODULE_P33,15}, IfxPort_OutputIdx_alt2};
IfxCan_Txd_Out IfxCan_TXD32_P10_2_OUT = {&MODULE_CAN3, IfxCan_NodeId_2, {&MODULE_P10, 2}, IfxPort_OutputIdx_alt2};
IfxCan_Txd_Out IfxCan_TXD32_P20_9_OUT = {&MODULE_CAN3, IfxCan_NodeId_2, {&MODULE_P20, 9}, IfxPort_OutputIdx_alt2};
IfxCan_Txd_Out IfxCan_TXD33_P13_3_OUT = {&MODULE_CAN3, IfxCan_NodeId_3, {&MODULE_P13, 3}, IfxPort_OutputIdx_alt7};
IfxCan_Txd_Out IfxCan_TXD33_P21_7_OUT = {&MODULE_CAN3, IfxCan_NodeId_3, {&MODULE_P21, 7}, IfxPort_OutputIdx_alt4};
IfxCan_Txd_Out IfxCan_TXD40_P10_1_OUT = {&MODULE_CAN4, IfxCan_NodeId_0, {&MODULE_P10, 1}, IfxPort_OutputIdx_alt6};
IfxCan_Txd_Out IfxCan_TXD40_P21_1_OUT = {&MODULE_CAN4, IfxCan_NodeId_0, {&MODULE_P21, 1}, IfxPort_OutputIdx_alt2};
IfxCan_Txd_Out IfxCan_TXD41_P14_1_OUT = {&MODULE_CAN4, IfxCan_NodeId_1, {&MODULE_P14, 1}, IfxPort_OutputIdx_alt3};
IfxCan_Txd_Out IfxCan_TXD41_P22_3_OUT = {&MODULE_CAN4, IfxCan_NodeId_1, {&MODULE_P22, 3}, IfxPort_OutputIdx_alt6};
IfxCan_Txd_Out IfxCan_TXD42_P15_5_OUT = {&MODULE_CAN4, IfxCan_NodeId_2, {&MODULE_P15, 5}, IfxPort_OutputIdx_alt4};
IfxCan_Txd_Out IfxCan_TXD42_P22_11_OUT = {&MODULE_CAN4, IfxCan_NodeId_2, {&MODULE_P22,11}, IfxPort_OutputIdx_alt6};
IfxCan_Txd_Out IfxCan_TXD43_P15_8_OUT = {&MODULE_CAN4, IfxCan_NodeId_3, {&MODULE_P15, 8}, IfxPort_OutputIdx_alt2};
IfxCan_Txd_Out IfxCan_TXD43_P34_5_OUT = {&MODULE_CAN4, IfxCan_NodeId_3, {&MODULE_P34, 5}, IfxPort_OutputIdx_alt3};
