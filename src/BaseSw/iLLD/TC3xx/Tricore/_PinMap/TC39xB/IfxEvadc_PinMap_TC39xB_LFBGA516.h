/**
 * \file IfxEvadc_PinMap_TC39xB_LFBGA516.h
 * \brief EVADC I/O map
...
#ifndef IFXEVADC_PINMAP_TC39XB_LFBGA516_H
#define IFXEVADC_PINMAP_TC39XB_LFBGA516_H 1
...
IFX_EXTERN IfxEvadc_GxBfl_Out IfxEvadc_FC4BFLOUT_P00_4_OUT;  /**< \brief Boundary flag output, FC channel 4 */
IFX_EXTERN IfxEvadc_GxBfl_Out IfxEvadc_FC4BFLOUT_P01_8_OUT;  /**< \brief Boundary flag output, FC channel 4 */
IFX_EXTERN IfxEvadc_GxBfl_Out IfxEvadc_FC4BFLOUT_P33_1_OUT;  /**< \brief Boundary flag output, FC channel 4 */
IFX_EXTERN IfxEvadc_GxBfl_Out IfxEvadc_FC5BFLOUT_P00_6_OUT;  /**< \brief Boundary flag output, FC channel 5 */
IFX_EXTERN IfxEvadc_GxBfl_Out IfxEvadc_FC5BFLOUT_P01_9_OUT;  /**< \brief Boundary flag output, FC channel 5 */
IFX_EXTERN IfxEvadc_GxBfl_Out IfxEvadc_FC5BFLOUT_P33_3_OUT;  /**< \brief Boundary flag output, FC channel 5 */
IFX_EXTERN IfxEvadc_GxBfl_Out IfxEvadc_FC6BFLOUT_P01_10_OUT;  /**< \brief Boundary flag output, FC channel 6 */
IFX_EXTERN IfxEvadc_GxBfl_Out IfxEvadc_FC6BFLOUT_P10_0_OUT;  /**< \brief Boundary flag output, FC channel 6 */
IFX_EXTERN IfxEvadc_GxBfl_Out IfxEvadc_FC6BFLOUT_P34_4_OUT;  /**< \brief Boundary flag output, FC channel 6 */
IFX_EXTERN IfxEvadc_GxBfl_Out IfxEvadc_FC7BFLOUT_P01_11_OUT;  /**< \brief Boundary flag output, FC channel 7 */
IFX_EXTERN IfxEvadc_GxBfl_Out IfxEvadc_FC7BFLOUT_P10_6_OUT;  /**< \brief Boundary flag output, FC channel 7 */
IFX_EXTERN IfxEvadc_GxBfl_Out IfxEvadc_FC7BFLOUT_P34_5_OUT;  /**< \brief Boundary flag output, FC channel 7 */
...
IFX_EXTERN IfxEvadc_Vadcg_In IfxEvadc_FC4CH0_P33_3_IN;  /**< \brief Analog input FC channel 4 */
IFX_EXTERN IfxEvadc_Vadcg_In IfxEvadc_FC5CH0_P33_2_IN;  /**< \brief Analog input FC channel 5 */
IFX_EXTERN IfxEvadc_Vadcg_In IfxEvadc_FC6CH0_P33_1_IN;  /**< \brief Analog input FC channel 6 */
IFX_EXTERN IfxEvadc_Vadcg_In IfxEvadc_FC7CH0_P33_0_IN;  /**< \brief Analog input FC channel 7 */
...
IFX_EXTERN IfxEvadc_Vadcg_In IfxEvadc_G4CH0_AN40_IN;  /**< \brief Analog input channel 0, group 4 */
IFX_EXTERN IfxEvadc_Vadcg_In IfxEvadc_G4CH1_AN41_IN;  /**< \brief Analog input channel 1, group 4 */
IFX_EXTERN IfxEvadc_Vadcg_In IfxEvadc_G4CH2_AN42_IN;  /**< \brief Analog input channel 2, group 4 */
IFX_EXTERN IfxEvadc_Vadcg_In IfxEvadc_G4CH3_AN43_IN;  /**< \brief Analog input channel 3, group 4 */
IFX_EXTERN IfxEvadc_Vadcg_In IfxEvadc_G4CH4_P40_13_IN;  /**< \brief Analog input channel 4, group 4 */
IFX_EXTERN IfxEvadc_Vadcg_In IfxEvadc_G4CH5_P40_14_IN;  /**< \brief Analog input channel 5, group 4 */
IFX_EXTERN IfxEvadc_Vadcg_In IfxEvadc_G4CH6_AN30_IN;  /**< \brief Analog input channel 6, group 4 */
IFX_EXTERN IfxEvadc_Vadcg_In IfxEvadc_G4CH7_AN31_IN;  /**< \brief Analog input channel 7, group 4 */
IFX_EXTERN IfxEvadc_Vadcg_In IfxEvadc_G5CH0_AN48_IN;  /**< \brief Analog input channel 0, group 5 */
IFX_EXTERN IfxEvadc_Vadcg_In IfxEvadc_G5CH1_AN49_IN;  /**< \brief Analog input channel 1, group 5 */
IFX_EXTERN IfxEvadc_Vadcg_In IfxEvadc_G5CH2_AN50_IN;  /**< \brief Analog input channel 2, group 5 */
IFX_EXTERN IfxEvadc_Vadcg_In IfxEvadc_G5CH3_AN51_IN;  /**< \brief Analog input channel 3, group 5 */
IFX_EXTERN IfxEvadc_Vadcg_In IfxEvadc_G5CH4_AN52_IN;  /**< \brief Analog input channel 4, group 5 */
IFX_EXTERN IfxEvadc_Vadcg_In IfxEvadc_G5CH5_AN53_IN;  /**< \brief Analog input channel 5, group 5 */
IFX_EXTERN IfxEvadc_Vadcg_In IfxEvadc_G5CH6_P41_4_IN;  /**< \brief Analog input channel 6, group 5 */
IFX_EXTERN IfxEvadc_Vadcg_In IfxEvadc_G5CH7_P41_5_IN;  /**< \brief Analog input channel 7, group 5 */
IFX_EXTERN IfxEvadc_Vadcg_In IfxEvadc_G6CH0_AN56_IN;  /**< \brief Analog input channel 0, group 6 */
IFX_EXTERN IfxEvadc_Vadcg_In IfxEvadc_G6CH1_AN57_IN;  /**< \brief Analog input channel 1, group 6 */
IFX_EXTERN IfxEvadc_Vadcg_In IfxEvadc_G6CH2_AN58_IN;  /**< \brief Analog input channel 2, group 6 */
IFX_EXTERN IfxEvadc_Vadcg_In IfxEvadc_G6CH3_AN59_IN;  /**< \brief Analog input channel 3, group 6 */
IFX_EXTERN IfxEvadc_Vadcg_In IfxEvadc_G6CH4_AN60_IN;  /**< \brief Analog input channel 4, group 6 */
IFX_EXTERN IfxEvadc_Vadcg_In IfxEvadc_G6CH5_AN61_IN;  /**< \brief Analog input channel 5, group 6 */
IFX_EXTERN IfxEvadc_Vadcg_In IfxEvadc_G6CH6_P41_6_IN;  /**< \brief Analog input channel 6, group 6 */
IFX_EXTERN IfxEvadc_Vadcg_In IfxEvadc_G6CH7_P41_7_IN;  /**< \brief Analog input channel 7, group 6 */
IFX_EXTERN IfxEvadc_Vadcg_In IfxEvadc_G7CH0_P41_8_IN;  /**< \brief Analog input channel 0, group 7 */
IFX_EXTERN IfxEvadc_Vadcg_In IfxEvadc_G7CH1_AN65_IN;  /**< \brief Analog input channel 1, group 7 */
IFX_EXTERN IfxEvadc_Vadcg_In IfxEvadc_G7CH2_AN66_IN;  /**< \brief Analog input channel 2, group 7 */
IFX_EXTERN IfxEvadc_Vadcg_In IfxEvadc_G7CH3_P40_15_IN;  /**< \brief Analog input channel 3, group 7 */
IFX_EXTERN IfxEvadc_Vadcg_In IfxEvadc_G7CH4_P41_0_IN;  /**< \brief Analog input channel 4, group 7 */
IFX_EXTERN IfxEvadc_Vadcg_In IfxEvadc_G7CH5_P41_1_IN;  /**< \brief Analog input channel 5, group 7 */
IFX_EXTERN IfxEvadc_Vadcg_In IfxEvadc_G7CH6_P41_2_IN;  /**< \brief Analog input channel 6, group 7 */
IFX_EXTERN IfxEvadc_Vadcg_In IfxEvadc_G7CH7_P41_3_IN;  /**< \brief Analog input channel 7, group 7 */
...
#define IFXEVADC_PINMAP_NUM_GROUPS 20
...
#endif /* IFXEVADC_PINMAP_TC39XB_LFBGA516_H */
