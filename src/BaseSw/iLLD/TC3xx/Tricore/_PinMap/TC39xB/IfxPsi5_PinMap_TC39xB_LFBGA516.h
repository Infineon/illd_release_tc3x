/**
 * \file IfxPsi5_PinMap_TC39xB_LFBGA516.h
 * \brief PSI5 I/O map
 * \ingroup IfxLld_Psi5
 *
 * \version iLLD_1_22_0
...
#ifndef IFXPSI5_PINMAP_TC39XB_LFBGA516_H
#define IFXPSI5_PINMAP_TC39XB_LFBGA516_H 1
...
IFX_EXTERN IfxPsi5_Rx_In IfxPsi5_RX2A_P00_5_IN;  /**< \brief RXD inputs (receive data) channel 2 */
IFX_EXTERN IfxPsi5_Rx_In IfxPsi5_RX2B_P02_7_IN;  /**< \brief RXD inputs (receive data) channel 2 */
IFX_EXTERN IfxPsi5_Rx_In IfxPsi5_RX2C_P33_5_IN;  /**< \brief RXD inputs (receive data) channel 2 */
IFX_EXTERN IfxPsi5_Rx_In IfxPsi5_RX3A_P13_10_IN;  /**< \brief RXD inputs (receive data) channel 3 */
IFX_EXTERN IfxPsi5_Rx_In IfxPsi5_RX3B_P13_13_IN;  /**< \brief RXD inputs (receive data) channel 3 */
IFX_EXTERN IfxPsi5_Rx_In IfxPsi5_RX3C_P10_6_IN;  /**< \brief RXD inputs (receive data) channel 3 */
...
IFX_EXTERN IfxPsi5_Tx_Out IfxPsi5_TX2_P00_6_OUT;  /**< \brief TXD outputs (send data) */
IFX_EXTERN IfxPsi5_Tx_Out IfxPsi5_TX2_P02_8_OUT;  /**< \brief TXD outputs (send data) */
IFX_EXTERN IfxPsi5_Tx_Out IfxPsi5_TX2_P33_6_OUT;  /**< \brief TXD outputs (send data) */
IFX_EXTERN IfxPsi5_Tx_Out IfxPsi5_TX3_P10_5_OUT;  /**< \brief TXD outputs (send data) */
IFX_EXTERN IfxPsi5_Tx_Out IfxPsi5_TX3_P13_11_OUT;  /**< \brief TXD outputs (send data) */
IFX_EXTERN IfxPsi5_Tx_Out IfxPsi5_TX3_P13_15_OUT;  /**< \brief TXD outputs (send data) */

/** \brief Table dimensions */
#define IFXPSI5_PINMAP_NUM_MODULES 1
#define IFXPSI5_PINMAP_NUM_CHANNELS 4
...
#endif /* IFXPSI5_PINMAP_TC39XB_LFBGA516_H */
