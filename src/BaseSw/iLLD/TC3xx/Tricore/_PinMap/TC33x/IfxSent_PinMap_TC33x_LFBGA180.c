/**
 * \file IfxSent_PinMap_TC33x_LFBGA180.c
 * \brief SENT I/O map
 * \ingroup IfxLld_Sent
 *
 * \version iLLD_1_22_0
...
#endif
#if defined DEVICE_TC33X && defined IFX_PIN_PACKAGE_LFBGA180

#include "IfxSent_PinMap_TC33x_LFBGA180.h"

IfxSent_Sent_In IfxSent_SENT0A_P40_6_IN = {&MODULE_SENT, IfxSent_ChannelId_0, {&MODULE_P40, 6}, Ifx_RxSel_a};
...
IfxSent_Sent_In IfxSent_SENT1A_P40_7_IN = {&MODULE_SENT, IfxSent_ChannelId_1, {&MODULE_P40, 7}, Ifx_RxSel_a};
...
IfxSent_Sent_In IfxSent_SENT2A_P40_8_IN = {&MODULE_SENT, IfxSent_ChannelId_2, {&MODULE_P40, 8}, Ifx_RxSel_a};
...
IfxSent_Sent_In IfxSent_SENT3A_P40_9_IN = {&MODULE_SENT, IfxSent_ChannelId_3, {&MODULE_P40, 9}, Ifx_RxSel_a};
