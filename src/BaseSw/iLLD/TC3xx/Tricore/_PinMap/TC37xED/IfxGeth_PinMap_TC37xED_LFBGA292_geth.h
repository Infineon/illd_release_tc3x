/**
 * \file IfxGeth_PinMap_TC37xED_LFBGA292_geth.h
 * \brief GETH I/O map
 * \ingroup IfxLld_Geth
 *
 * \version iLLD_1_22_0
...
#ifndef IFXGETH_PINMAP_TC37XED_LFBGA292_GETH_H
#define IFXGETH_PINMAP_TC37XED_LFBGA292_GETH_H  1
...
IFX_EXTERN IfxGeth_Col_In IfxGeth1_COL_P22_2_IN;  /**< \brief Collision MII */
IFX_EXTERN IfxGeth_Col_In IfxGeth_COL_P11_15_IN;  /**< \brief Collision MII */
IFX_EXTERN IfxGeth_Crs_In IfxGeth1_CRSA_P22_0_IN;  /**< \brief Carrier Sense MII */
IFX_EXTERN IfxGeth_Crs_In IfxGeth1_CRSB_P22_6_IN;  /**< \brief Carrier Sense MII */
...
IFX_EXTERN IfxGeth_Crsdv_In IfxGeth1_CRSDVA_P22_6_IN;  /**< \brief Carrier Sense / Data Valid combi-signal for RMII */
IFX_EXTERN IfxGeth_Crsdv_In IfxGeth1_CRSDVB_P22_0_IN;  /**< \brief Carrier Sense / Data Valid combi-signal for RMII */
...
IFX_EXTERN IfxGeth_Grefclk_In IfxGeth1_GREFCLK_P22_7_IN;  /**< \brief Gigabit Reference Clock input for RGMII (125 MHz high precission) */
...
IFX_EXTERN IfxGeth_Mdc_Out IfxGeth1_MDC_P22_8_OUT;  /**< \brief MDIO clock */
...
IFX_EXTERN IfxGeth_Mdio_InOut IfxGeth1_MDIO_P22_9_INOUT;  /**< \brief MDIO Output */
...
IFX_EXTERN IfxGeth_Pps_Out IfxGeth1_PPS_P21_0_OUT;  /**< \brief Pulse Per Second */
IFX_EXTERN IfxGeth_Pps_Out IfxGeth_PPS_P14_4_OUT;  /**< \brief Pulse Per Second */
IFX_EXTERN IfxGeth_Refclk_In IfxGeth1_REFCLKA_P22_5_IN;  /**< \brief Reference Clock input for RMII (50 MHz) */
IFX_EXTERN IfxGeth_Refclk_In IfxGeth_REFCLKA_P11_12_IN;  /**< \brief Reference Clock input for RMII (50 MHz) */
IFX_EXTERN IfxGeth_Rxclk_In IfxGeth1_RXCLKA_P22_5_IN;  /**< \brief Receive Clock MII */
IFX_EXTERN IfxGeth_Rxclk_In IfxGeth1_RXCLKB_P22_12_IN;  /**< \brief Receive Clock MII */
IFX_EXTERN IfxGeth_Rxclk_In IfxGeth1_RXCLKC_P22_8_IN;  /**< \brief Receive Clock MII */
...
IFX_EXTERN IfxGeth_Rxctl_In IfxGeth1_RXCTLA_P22_6_IN;  /**< \brief Receive Control for RGMII */
IFX_EXTERN IfxGeth_Rxctl_In IfxGeth_RXCTLA_P11_11_IN;  /**< \brief Receive Control for RGMII */
IFX_EXTERN IfxGeth_Rxd_In IfxGeth1_RXD0A_P22_4_IN;  /**< \brief Receive Data 0 MII, RMII and RGMII (RGMII can use RXD0A only) */
IFX_EXTERN IfxGeth_Rxd_In IfxGeth1_RXD1A_P23_7_IN;  /**< \brief Receive Data 1 MII, RMII and RGMII (RGMII can use RXD1A only) */
IFX_EXTERN IfxGeth_Rxd_In IfxGeth1_RXD2A_P23_6_IN;  /**< \brief Receive Data 2 MII and RGMII  (RGMII can use RXD2A only) */
IFX_EXTERN IfxGeth_Rxd_In IfxGeth1_RXD3A_P23_5_IN;  /**< \brief Receive Data 3 MII and RGMII  (RGMII can use RXD3A only) */
...
IFX_EXTERN IfxGeth_Rxdv_In IfxGeth1_RXDVA_P22_6_IN;  /**< \brief Receive Data Valid MII */
IFX_EXTERN IfxGeth_Rxdv_In IfxGeth1_RXDVB_P22_0_IN;  /**< \brief Receive Data Valid MII */
...
IFX_EXTERN IfxGeth_Rxer_In IfxGeth1_RXERA_P22_1_IN;  /**< \brief Receive Error MII */
...
IFX_EXTERN IfxGeth_Txclk_In IfxGeth1_TXCLKA_P22_7_IN;  /**< \brief Transmit Clock Input for MII */
IFX_EXTERN IfxGeth_Txclk_In IfxGeth1_TXCLKB_P22_5_IN;  /**< \brief Transmit Clock Input for MII */
...
IFX_EXTERN IfxGeth_Txclk_Out IfxGeth1_TXCLK_P22_12_OUT;  /**< \brief Transmit Clock Output for RGMII */
IFX_EXTERN IfxGeth_Txclk_Out IfxGeth_TXCLK_P11_4_OUT;  /**< \brief Transmit Clock Output for RGMII */
IFX_EXTERN IfxGeth_Txctl_Out IfxGeth1_TXCTL_P22_11_OUT;  /**< \brief GETH1_TXEN 0: Transmit Control for RGMII */
IFX_EXTERN IfxGeth_Txctl_Out IfxGeth_TXCTL_P11_6_OUT;  /**< \brief GETH_TXEN 0: Transmit Control for RGMII */
IFX_EXTERN IfxGeth_Txd_Out IfxGeth1_TXD0_P22_10_OUT;  /**< \brief Transmit Data */
IFX_EXTERN IfxGeth_Txd_Out IfxGeth1_TXD1_P23_4_OUT;  /**< \brief Transmit Data */
IFX_EXTERN IfxGeth_Txd_Out IfxGeth1_TXD2_P23_3_OUT;  /**< \brief Transmit Data */
IFX_EXTERN IfxGeth_Txd_Out IfxGeth1_TXD3_P23_2_OUT;  /**< \brief Transmit Data */
...
IFX_EXTERN IfxGeth_Txen_Out IfxGeth1_TXEN_P22_11_OUT;  /**< \brief Transmit Enable MII and RMII */
IFX_EXTERN IfxGeth_Txen_Out IfxGeth_TXEN_P11_6_OUT;  /**< \brief Transmit Enable MII and RMII */
IFX_EXTERN IfxGeth_Txer_Out IfxGeth1_TXER_P22_12_OUT;  /**< \brief Transmit Error MII */
IFX_EXTERN IfxGeth_Txer_Out IfxGeth_TXER_P11_4_OUT;  /**< \brief Transmit Error MII */

/** \brief Table dimensions */
#define IFXGETH_PINMAP_NUM_MODULES 2
...
#endif /* IFXGETH_PINMAP_TC37XED_LFBGA292_GETH_H */
