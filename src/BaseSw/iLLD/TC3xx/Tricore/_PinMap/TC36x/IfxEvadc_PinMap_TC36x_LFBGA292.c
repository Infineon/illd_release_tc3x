/**
 * \file IfxEvadc_PinMap_TC36x_LFBGA292.c
 * \brief EVADC I/O map
...
#if defined DEVICE_TC36X && defined IFX_PIN_PACKAGE_LFBGA292
...
IfxEvadc_Vadcg_In IfxEvadc_FC1CH0_AN17_IN = {&MODULE_EVADC, IfxEvadc_GroupId_13, {NULL_PTR,17}, 0};
...
IfxEvadc_Vadcg_In IfxEvadc_G3CH4_AN28_IN = {&MODULE_EVADC, IfxEvadc_GroupId_3, {NULL_PTR,28}, 4};
IfxEvadc_Vadcg_In IfxEvadc_G3CH5_AN29_IN = {&MODULE_EVADC, IfxEvadc_GroupId_3, {NULL_PTR,29}, 5};
...
const IfxEvadc_Vadcg_In *IfxEvadc_Vadcg_In_pinTable[IFXEVADC_PINMAP_NUM_MODULES][IFXEVADC_PINMAP_NUM_GROUPS][IFXEVADC_PINMAP_VADCG_IN_NUM_ITEMS] = {
    {
        ...
        },
        {
            ...
            &IfxEvadc_G3CH4_AN28_IN,
            &IfxEvadc_G3CH5_AN29_IN,
