...
#include "IfxCcu6_PinMap_TC39xB_516.h"
#elif defined(IFX_PIN_PACKAGE_LFBGA292)
#include "IfxCcu6_PinMap_TC39xB_LFBGA292.h"
#elif defined(IFX_PIN_PACKAGE_LFBGA292_ADAS)
#include "IfxCcu6_PinMap_TC39xB_LFBGA292_adas.h"
#elif defined(IFX_PIN_PACKAGE_LFBGA516)
#include "IfxCcu6_PinMap_TC39xB_LFBGA516.h"
...
#if defined(IFX_PIN_PACKAGE_516)
#include "IfxCcu6_PinMap_TC38x_516.h"
#elif defined(IFX_PIN_PACKAGE_LFBGA292)
#include "IfxCcu6_PinMap_TC38x_LFBGA292.h"
#elif defined(IFX_PIN_PACKAGE_LFBGA516)
#include "IfxCcu6_PinMap_TC38x_LFBGA516.h"
...
#if defined(IFX_PIN_PACKAGE_516)
#include "IfxCcu6_PinMap_TC38EVOx_516.h"
#elif defined(IFX_PIN_PACKAGE_LFBGA292)
#include "IfxCcu6_PinMap_TC38EVOx_LFBGA292.h"
...
#if defined(IFX_PIN_PACKAGE_516)
#include "IfxCcu6_PinMap_TC37xED_516.h"
#elif defined(IFX_PIN_PACKAGE_LFBGA292)
#include "IfxCcu6_PinMap_TC37xED_LFBGA292.h"
#elif defined(IFX_PIN_PACKAGE_LFBGA292_GETH)
#include "IfxCcu6_PinMap_TC37xED_LFBGA292_geth.h"
#elif defined(IFX_PIN_PACKAGE_LQFP144)
#include "IfxCcu6_PinMap_TC37xED_LQFP144.h"
#elif defined(IFX_PIN_PACKAGE_LQFP176)
#include "IfxCcu6_PinMap_TC37xED_LQFP176.h"
#elif defined(IFX_PIN_PACKAGE_TQFP144)
#include "IfxCcu6_PinMap_TC37xED_TQFP144.h"
...
#if defined(IFX_PIN_PACKAGE_516)
#include "IfxCcu6_PinMap_TC37x_516.h"
#elif defined(IFX_PIN_PACKAGE_LFBGA292)
#include "IfxCcu6_PinMap_TC37x_LFBGA292.h"
#elif defined(IFX_PIN_PACKAGE_LQFP176)
#include "IfxCcu6_PinMap_TC37x_LQFP176.h"
...
#if defined(IFX_PIN_PACKAGE_516)
#include "IfxCcu6_PinMap_TC36x_516.h"
#elif defined(IFX_PIN_PACKAGE_LFBGA180)
#include "IfxCcu6_PinMap_TC36x_LFBGA180.h"
#elif defined(IFX_PIN_PACKAGE_LFBGA292)
#include "IfxCcu6_PinMap_TC36x_LFBGA292.h"
#elif defined(IFX_PIN_PACKAGE_LQFP144)
#include "IfxCcu6_PinMap_TC36x_LQFP144.h"
#elif defined(IFX_PIN_PACKAGE_LQFP176)
#include "IfxCcu6_PinMap_TC36x_LQFP176.h"
#elif defined(IFX_PIN_PACKAGE_TQFP144)
#include "IfxCcu6_PinMap_TC36x_TQFP144.h"
...
#if defined(IFX_PIN_PACKAGE_516)
#include "IfxCcu6_PinMap_TC35x_516.h"
#elif defined(IFX_PIN_PACKAGE_LFBGA180_ADAS)
#include "IfxCcu6_PinMap_TC35x_LFBGA180_adas.h"
#elif defined(IFX_PIN_PACKAGE_LFBGA292_ADAS)
#include "IfxCcu6_PinMap_TC35x_LFBGA292_adas.h"
...
#if defined(IFX_PIN_PACKAGE_516)
#include "IfxCcu6_PinMap_TC33xED_516.h"
#elif defined(IFX_PIN_PACKAGE_LFBGA180_ADAS)
#include "IfxCcu6_PinMap_TC33xED_LFBGA180_adas.h"
#elif defined(IFX_PIN_PACKAGE_LFBGA292_ADAS)
#include "IfxCcu6_PinMap_TC33xED_LFBGA292_adas.h"
#elif defined(IFX_PIN_PACKAGE_LFBGA180) || defined(IFX_PIN_PACKAGE_LFBGA516) || defined(IFX_PIN_PACKAGE_LFBGA292) || defined(IFX_PIN_PACKAGE_TQFP80) || defined(IFX_PIN_PACKAGE_TQFP100) || defined(IFX_PIN_PACKAGE_TQFP144) || defined(IFX_PIN_PACKAGE_LQFP144) || defined(IFX_PIN_PACKAGE_LQFP176) || defined(IFX_PIN_PACKAGE_LFBGA292_GETH)
#error "The pin package enabled in Ifx_Cfg.h file is not supported for the selected device"
#endif
...
#if defined(IFX_PIN_PACKAGE_516)
#include "IfxCcu6_PinMap_TC33x_516.h"
#elif defined(IFX_PIN_PACKAGE_LFBGA180)
#include "IfxCcu6_PinMap_TC33x_LFBGA180.h"
#elif defined(IFX_PIN_PACKAGE_LFBGA292)
#include "IfxCcu6_PinMap_TC33x_LFBGA292.h"
#elif defined(IFX_PIN_PACKAGE_TQFP80)
#include "IfxCcu6_PinMap_TC33x_TQFP80.h"
#elif defined(IFX_PIN_PACKAGE_TQFP100)
#include "IfxCcu6_PinMap_TC33x_TQFP100.h"
#elif defined(IFX_PIN_PACKAGE_TQFP144)
#include "IfxCcu6_PinMap_TC33x_TQFP144.h"
