...
#ifndef IFXGLOBAL_TC36X_H
#define IFXGLOBAL_TC36X_H                 1
 ...
 */
#define IFXGLOBAL_DERIVATIVE_TC36x (1)

/** \brief Microcontroller derivative name
 */
#define IFXGLOBAL_DERIVATIVE_NAME   "TC36x"

#endif /* IFXGLOBAL_TC36X_H */
