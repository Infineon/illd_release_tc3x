...
#ifndef IFXEVADC_CFG_TC35X_H
#define IFXEVADC_CFG_TC35X_H 1
 ...
 */
#define IFXEVADC_NUM_ADC_SECONDARY_GROUPS               (0)
 ...
 */
#define IFXEVADC_NUM_CHAN_PER_SEC_GROUP                 (0)
