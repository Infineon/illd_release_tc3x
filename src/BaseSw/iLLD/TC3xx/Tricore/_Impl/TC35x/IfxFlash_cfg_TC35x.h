...
#ifndef IFXFLASH_CFG_TC35X_H
#define IFXFLASH_CFG_TC35X_H 1
...
/** \brief p flash end
 */
#define IFXFLASH_PFLASH_END                              (IFXFLASH_PFLASH_START + 0x300000 + 0x200000 - 1)

/** \brief
 */
#define IFXFLASH_PFLASH_NUM_LOG_SECTORS                  ((128 * 2))

#define IFXFLASH_PFLASH_NUM_PHYSICAL_SECTORS             (2 * 2)
...
/** \brief PF0 size
 */
#define IFXFLASH_PFLASH_P0_SIZE                          (0x200000)
...
/** \brief PF1 size
 */
#define IFXFLASH_PFLASH_P1_SIZE                          (0x200000)

/** \brief PF1 start
 */
#define IFXFLASH_PFLASH_P1_START                         (IFXFLASH_PFLASH_P0_START + 0x300000)
 ...
 */
#define IFXFLASH_PFLASH_BUSY_STATUS_MASK				 (0x1FU)
