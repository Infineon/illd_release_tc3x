...
#ifndef IFXSCU_CFG_TC33X_H
#define IFXSCU_CFG_TC33X_H 1
/******************************************************************************/
#include "Ifx_Cfg.h"
#include "IfxScu_bf.h"
...
#ifndef IFXSCU_CFG_PLL_STEPS_FDCO_640MHZ_TO_TARGET_160MHZ
#define IFXSCU_CFG_PLL_STEPS_FDCO_640MHZ_TO_TARGET_160MHZ             \
    {                   /*Step 1 Config: 120MHz*/                     \
        (6 - 1),        /*uint8 k2Step;*/                             \
        0.000100,       /*float32 waitTime;*/                         \
    },                                                                \
    {                   /*Step 3 Config: 160MHz*/                     \
        (4 - 1),        /*uint8 k2Step;*/                             \
        0.000100,       /*float32 waitTime;*/                         \
    }
#endif /*#ifndef IFXSCU_CFG_PLL_STEPS_FDCO_6400MHZ_TO_TARGET_160MHZ */
...
/************** Target = 160MHz *****************/
 ...
 #ifndef IFXSCU_CFG_SYS_PLL_20MHZ_160MHZ
/**** Macro for Initial Pll step, for profile with 20MHz Crystal and 160MHz target (fDCO= 640)*/
#define IFXSCU_CFG_SYS_PLL_20MHZ_160MHZ                            \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial }*/            \
    {(1 - 1), (32 - 1), (8 - 1)}
#endif /*#ifndef IFXSCU_CFG_SYS_PLL_20MHZ_160MHZ */

#ifndef IFXSCU_CFG_WAIT_INITIAL_STEP_20MHZ_160MHZ
#define IFXSCU_CFG_WAIT_INITIAL_STEP_20MHZ_160MHZ 0.000200F
#endif /*#ifndef IFXSCU_CFG_WAIT_INITIAL_STEP_20MHZ_160MHZ */

#ifndef IFXSCU_CFG_PLL_STEPS_20MHZ_160MHZ
/**** Macro for Pll step for profile with 20MHz Crystal and 160MHz target (fDCO= 640MHz)*/
#define IFXSCU_CFG_PLL_STEPS_20MHZ_160MHZ  IFXSCU_CFG_PLL_STEPS_FDCO_640MHZ_TO_TARGET_160MHZ
...
/**************** Fsource = Fpll0 = 160MHz **********************************************************/

/************** CCUCON0 : STMDIV  (Output : fSTM)**************/
/* Target = 80 MHz AND Source = Fsource0 */
#ifndef IFXSCU_CFG_STMDIV_160MHZ
#define IFXSCU_CFG_STMDIV_160MHZ             (2)
#endif /*#ifndef IFXSCU_CFG_STMDIV_160MHZ */

/************** CCUCON0 : GTMDIV  (Output : fGTM)**************/
/* Target = 160 MHz AND Source = Fsource0 */
#ifndef IFXSCU_CFG_GTMDIV_160MHZ
#define IFXSCU_CFG_GTMDIV_160MHZ             (1)
...
#define IFXSCU_CFG_SPBDIV_160MHZ             (2)
#endif /*#ifndef IFXSCU_CFG_SPBDIV_160MHZ */

/************** CCUCON0 : BBBDIV  (Output : fBBB)**************/
/* Target = 80 MHz AND Source = Fsource0 */
#ifndef IFXSCU_CFG_BBBDIV_160MHZ
#define IFXSCU_CFG_BBBDIV_160MHZ             (2)
#endif /*#ifndef IFXSCU_CFG_BBBDIV_160MHZ */

/************** CCUCON0 : FSIDIV  (Output : fFSI)**************/
/* Target = 80 MHz AND Source = Fsri */
#ifndef IFXSCU_CFG_FSIDIV_160MHZ
#define IFXSCU_CFG_FSIDIV_160MHZ             (IFXSCU_CFG_SRIDIV_160MHZ * 2)
#endif /*#ifndef IFXSCU_CFG_FSIDIV_160MHZ */

/************** CCUCON0 : FSI2DIV  (Output : fFSI2)**************/
/* Target = 160 MHz AND Source = Fsri */
#ifndef IFXSCU_CFG_FSI2DIV_160MHZ
#define IFXSCU_CFG_FSI2DIV_160MHZ             (IFXSCU_CFG_SRIDIV_160MHZ * 1)
#endif /*#ifndef IFXSCU_CFG_FSI2DIV_160MHZ */

/************** CCUCON5 : MCANHDIV  (Output : fMCANH)**************/
/* Target = 80 MHz AND Source = Fsource0 */
#ifndef IFXSCU_CFG_MCANHDIV_160MHZ
#define IFXSCU_CFG_MCANHDIV_160MHZ             (2)
#endif /*#ifndef IFXSCU_CFG_MCANHDIV_160MHZ */
...
#define IFXSCULBIST_CFG_SIGNATURE_A         (0x740EF25AU)
#else
#define IFXSCULBIST_CFG_SIGNATURE_A         (0x8AA15905U)
#endif
#endif

#ifndef IFXSCULBIST_CFG_PATTERN_A
#define IFXSCULBIST_CFG_PATTERN_A           (0x140U)
#endif

#ifndef IFXSCULBIST_CFG_SCANCHAINLENGTH
#define IFXSCULBIST_CFG_SCANCHAINLENGTH     (0x39U)
#endif
