...
#ifndef IFXEVADC_CFG_TC33X_H
#define IFXEVADC_CFG_TC33X_H 1
 ...
 */
#define IFXEVADC_NUM_ADC_PRIMARY_GROUPS                 (2)

/** \brief Secondary Group
 */
#define IFXEVADC_NUM_ADC_SECONDARY_GROUPS               (2)

/** \brief Fast Compare Channel
 */
#define IFXEVADC_NUM_FAST_COMPARE_CHANNELS              (0)
 ...
 */
#define IFXEVADC_NUM_CHAN_PER_PRIM_GROUP                (16)

/** \brief Number of channels in secondary group
 */
#define IFXEVADC_NUM_CHAN_PER_SEC_GROUP                 (32)
