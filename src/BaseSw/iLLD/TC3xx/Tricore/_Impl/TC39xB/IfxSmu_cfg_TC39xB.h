...
#ifndef IFXSMU_CFG_TC39XB_H
#define IFXSMU_CFG_TC39XB_H 1
...
typedef enum
{
    ...
    IfxSmu_Alarm_CPU4_Buslevel_MpuViolation                               = 129, /**< \brief ALM4[1] : Safety Mechanism: Bus-level Memory Protection Unit Alarm: Bus-level MPU violation.*/
    IfxSmu_Alarm_CPU4_PFI4_PFLASH4_ReadPathError                          = 130, /**< \brief ALM4[2] : Safety Mechanism: PFLASH Read Path Monitor Alarm: PFLASH4 Read Path Error*/
    IfxSmu_Alarm_CPU4_PCACHETAG_UncorrectableErrorDetection      = 132, /**< \brief ALM4[4] : Safety Mechanism: SRAM Monitor  Alarm: PCACHE TAG Uncorrectable  error detection */
    IfxSmu_Alarm_CPU4_PCACHETAG_MiscellaneousErrorDetection               = 133, /**< \brief ALM4[5] : Safety Mechanism: SRAM Monitor Alarm: PCACHE TAG Miscellaneous error detection*/
    IfxSmu_Alarm_CPU4_PSPRPCACHE_SingleBitErrorCorrection                 = 134, /**< \brief ALM4[6] : Safety Mechanism: SRAM Monitor Alarm: PSPR/PCACHE Single bit error correction*/
    IfxSmu_Alarm_CPU4_PSPRPCACHE_UncorrectableErrorDetection     = 135, /**< \brief ALM4[7] : Safety Mechanism: SRAM Monitor  Alarm: PSPR/PCACHE Uncorrectable  error detection */
    IfxSmu_Alarm_CPU4_PSPRPCACHE_MiscellaneousErrorDetection              = 136, /**< \brief ALM4[8] : Safety Mechanism: SRAM Monitor Alarm: PSPR/PCACHE Miscellaneous error detection*/
    IfxSmu_Alarm_CPU4_DSPRDCACHEDLMU_SingleBitErrorCorrection             = 137, /**< \brief ALM4[9] : Safety Mechanism: SRAM Monitor Alarm: DSPR/DCACHE/DLMU Single bit error correction*/
    IfxSmu_Alarm_CPU4_DSPRDCACHEDLMU_UncorrectableErrorDetection = 138, /**< \brief ALM4[10] : Safety Mechanism(s): SRAM Monitor  Alarm: DSPR/DCACHE/DLMU Uncorrectable  error detection */
    IfxSmu_Alarm_CPU4_DSPRDCACHEDLMU_MiscellaneousErrorDetection          = 139, /**< \brief ALM4[11] : Safety Mechanism(s): SRAM Monitor Alarm: DSPR/DCACHE/DLMU Miscellaneous error detection*/
    IfxSmu_Alarm_CPU4_DCACHETAG_SingleBitErrorCorrection                  = 140, /**< \brief ALM4[12] : Safety Mechanism: SRAM Monitor Alarm: DCACHE TAG Single bit error correction*/
    IfxSmu_Alarm_CPU4_DCACHETAG_UncorrectableErrorDetection      = 141, /**< \brief ALM4[13] : Safety Mechanism: SRAM Monitor  Alarm: DCACHE TAG Uncorrectable  error detection */
    IfxSmu_Alarm_CPU4_DCACHETAG_MiscellaneousErrorDetection               = 142, /**< \brief ALM4[14] : Safety Mechanism: SRAM Monitor Alarm: DCACHE TAG Miscellaneous error detection*/
    IfxSmu_Alarm_CPU4_CPU_InstructionFetchSriInterfaceEdcError            = 150, /**< \brief ALM4[22] : Safety Mechanism: SRI End-to-End EDC Alarm: CPU Instruction Fetch SRI Interface EDC Error*/
    IfxSmu_Alarm_CPU4_CPU_DataSriInterfaceLoadStoreEdcError               = 151, /**< \brief ALM4[23] : Safety Mechanism: SRI End-to-End EDC Alarm: CPU Data SRI Interface (Load/Store) EDC Error*/
    IfxSmu_Alarm_CPU4_CPU_ExceptionInterruptTrap                     = 152, /**< \brief ALM4[24] : Safety Mechanism: Exception Monitor  Alarm: CPU exception (interrupt/trap) */
    IfxSmu_Alarm_CPU5_Buslevel_MpuViolation                               = 161, /**< \brief ALM5[1] : Safety Mechanism: Bus-level Memory Protection Unit Alarm: Bus-level MPU violation.*/
    IfxSmu_Alarm_CPU5_PFI5_PFLASH5_ReadPathError                          = 162, /**< \brief ALM5[2] : Safety Mechanism: PFLASH Read Path Monitor Alarm: PFLASH5 Read Path Error*/
    IfxSmu_Alarm_CPU5_PCACHETAG_UncorrectableErrorDetection      = 164, /**< \brief ALM5[4] : Safety Mechanism: SRAM Monitor  Alarm: PCACHE TAG Uncorrectable  error detection */
    IfxSmu_Alarm_CPU5_PCACHETAG_MiscellaneousErrorDetection               = 165, /**< \brief ALM5[5] : Safety Mechanism: SRAM Monitor Alarm: PCACHE TAG Miscellaneous error detection*/
    IfxSmu_Alarm_CPU5_PSPRPCACHE_SingleBitErrorCorrection                 = 166, /**< \brief ALM5[6] : Safety Mechanism: SRAM Monitor Alarm: PSPR/PCACHE Single bit error correction*/
    IfxSmu_Alarm_CPU5_PSPRPCACHE_UncorrectableErrorDetection     = 167, /**< \brief ALM5[7] : Safety Mechanism: SRAM Monitor  Alarm: PSPR/PCACHE Uncorrectable  error detection */
    IfxSmu_Alarm_CPU5_PSPRPCACHE_MiscellaneousErrorDetection              = 168, /**< \brief ALM5[8] : Safety Mechanism: SRAM Monitor Alarm: PSPR/PCACHE Miscellaneous error detection*/
    IfxSmu_Alarm_CPU5_DSPRDCACHEDLMU_SingleBitErrorCorrection             = 169, /**< \brief ALM5[9] : Safety Mechanism: SRAM Monitor Alarm: DSPR/DCACHE/DLMU Single bit error correction*/
    IfxSmu_Alarm_CPU5_DSPRDCACHEDLMU_UncorrectableErrorDetection = 170, /**< \brief ALM5[10] : Safety Mechanism(s): SRAM Monitor  Alarm: DSPR/DCACHE/DLMU Uncorrectable  error detection */
    IfxSmu_Alarm_CPU5_DSPRDCACHEDLMU_MiscellaneousErrorDetection          = 171, /**< \brief ALM5[11] : Safety Mechanism(s): SRAM Monitor Alarm: DSPR/DCACHE/DLMU Miscellaneous error detection*/
    IfxSmu_Alarm_CPU5_DCACHETAG_SingleBitErrorCorrection                  = 172, /**< \brief ALM5[12] : Safety Mechanism: SRAM Monitor  Alarm: DCACHE TAG Single bit error correction*/
    IfxSmu_Alarm_CPU5_DCACHETAG_UncorrectableErrorDetection      = 173, /**< \brief ALM5[13] : Safety Mechanism: SRAM Monitor  Alarm: DCACHE TAG Uncorrectable  error detection */
    IfxSmu_Alarm_CPU5_DCACHETAG_MiscellaneousErrorDetection               = 174, /**< \brief ALM5[14] : Safety Mechanism: SRAM Monitor Alarm: DCACHE TAG Miscellaneous error detection*/
    IfxSmu_Alarm_CPU5_CPU_InstructionFetchSriInterfaceEdcError            = 182, /**< \brief ALM5[22] : Safety Mechanism: SRI End-to-End EDC Alarm: CPU Instruction Fetch SRI Interface EDC Error*/
    IfxSmu_Alarm_CPU5_CPU_DataSriInterfaceLoadStoreEdcError               = 183, /**< \brief ALM5[23] : Safety Mechanism: SRI End-to-End EDC Alarm: CPU Data SRI Interface (Load/Store) EDC Error*/
    IfxSmu_Alarm_CPU5_CPU_ExceptionInterruptTrap                     = 184, /**< \brief ALM5[24] : Safety Mechanism: Exception Monitor  Alarm: CPU exception (interrupt/trap) */
    ...
    IfxSmu_Alarm_SPU_CIF_SPUCIF_SingleBitErrorCorrection                  = 230, /**< \brief ALM7[6] : Safety Mechanism: SRAM Monitor Alarm: SPU/CIF Single bit error correction*/
    IfxSmu_Alarm_SPU_CIF_SPUCIF_UncorrectableErrorDetection      = 231, /**< \brief ALM7[7] : Safety Mechanism: SRAM Monitor  Alarm: SPU/CIF Uncorrectable  error detection */
    IfxSmu_Alarm_SPU_CIF_SPUCIF_MiscellaneousErrorDetection               = 232, /**< \brief ALM7[8] : Safety Mechanism: SRAM Monitor Alarm: SPU/CIF Miscellaneous error detection*/
    ...
    IfxSmu_Alarm_SCU_CPU4_WatchdogTimeOut                                 = 270, /**< \brief ALM8[14] : Safety Mechanism: Watchdog Alarm: CPU4 Watchdog time-out*/
    IfxSmu_Alarm_SCU_CPU5_WatchdogTimeOut                                 = 271, /**< \brief ALM8[15] : Safety Mechanism: Watchdog Alarm: CPU5 Watchdog time-out*/
    ...
    IfxSmu_Alarm_SPULCKSTP_Lockstep_ComparatorAlarm                       = 311, /**< \brief ALM9[23] : Safety Mechanism: Lockstep Alarm: Lockstep Comparator Alarm*/
    ...
    IfxSmu_Alarm_HSSL_HSSL1EDC_ReadPhaseError                             = 363, /**< \brief ALM11[11] : Safety Mechanism: SRI Error Detection Code (EDC) Alarm: HSSL1 EDC Read Phase Error*/
