...
#ifndef IFXMSC_CFG_TC39XB_H
#define IFXMSC_CFG_TC39XB_H 1
...
typedef enum
{
    ...
    IfxMsc_Index_3           /**< \brief "MSC index "+str(x)  */
} IfxMsc_Index;
