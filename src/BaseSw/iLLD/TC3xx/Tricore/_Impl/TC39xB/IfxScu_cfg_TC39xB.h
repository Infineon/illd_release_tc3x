...
#ifndef IFXSCU_CFG_TC39XB_H
#define IFXSCU_CFG_TC39XB_H 1
/******************************************************************************/
#include "Ifx_Cfg.h"
#include "IfxScu_bf.h"
...
#elif (IFX_CFG_SCU_PLL_FREQUENCY == (400000000))
#define IFXSCU_CFG_PLL_FREQ 400MHZ
#else
#error "Wrong PLL frequency configuration!, check IFX_CFG_SCU_PLL_FREQUENCY configuration in Ifx_Cfg.h."
#error "Supported PLL frequencies are 80MHz, 133MHz (8MHz XTAL doesn't support), 160Mhz, 200MHz, 240Mhz, 300MHz, and 400MHz."
#endif
/******************************************************************************/
/*                           Per PLL Config                                   */
/******************************************************************************/
...
#ifndef IFXSCU_CFG_PLL_STEPS_FDCO_400MHZ_TO_TARGET_400MHZ
#define IFXSCU_CFG_PLL_STEPS_FDCO_400MHZ_TO_TARGET_400MHZ              \
    {                   /*Step 1 Config: 133.333333MHz*/                \
        (3 - 1),        /*uint8 k2Step;*/                               \
        0.000100,       /*float32 waitTime;*/                           \
    },                                                                   \
    {                   /*Step 2 Config: 200MHz*/                       \
    ...
    {                   /*Step 3 Config: 400MHz*/                       \
        (1 - 1),        /*uint8 k2Step;*/                               \
        0.000100,       /*float32 waitTime;*/                           \
    }
#endif /*#ifndef IFXSCU_CFG_PLL_STEPS_FDCO_400MHZ_TO_TARGET_400MHZ */
...
/************** Target = 400MHz *****************/
 ...
 #ifndef IFXSCU_CFG_SYS_PLL_16MHZ_400MHZ
/**** Macro for Initial Pll step, for profile with 16MHz Crystal and 400MHz target (fDCO= 400)*/
#define IFXSCU_CFG_SYS_PLL_16MHZ_400MHZ                            \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial }*/            \
    {(1 - 1), (25 - 1), (4 - 1)}
#endif /*#ifndef IFXSCU_CFG_SYS_PLL_16MHZ_400MHZ */

#ifndef IFXSCU_CFG_WAIT_INITIAL_STEP_16MHZ_400MHZ
#define IFXSCU_CFG_WAIT_INITIAL_STEP_16MHZ_400MHZ 0.000200F
#endif /*#ifndef IFXSCU_CFG_WAIT_INITIAL_STEP_16MHZ_400MHZ */

#ifndef IFXSCU_CFG_PLL_STEPS_16MHZ_400MHZ
/**** Macro for Pll step for profile with 16MHz Crystal and 400MHz target (fDCO= 400MHz)*/
#define IFXSCU_CFG_PLL_STEPS_16MHZ_400MHZ  IFXSCU_CFG_PLL_STEPS_FDCO_400MHZ_TO_TARGET_400MHZ
#endif /*#ifndef IFXSCU_CFG_PLL_STEPS_16MHZ_400MHZ */
...
/************** Target = 400MHz *****************/
 ...
 #ifndef IFXSCU_CFG_SYS_PLL_20MHZ_400MHZ
/**** Macro for Initial Pll step, for profile with 20MHz Crystal and 400MHz target (fDCO= 400)*/
#define IFXSCU_CFG_SYS_PLL_20MHZ_400MHZ                            \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial }*/            \
    {(1 - 1), (20 - 1), (4 - 1)}
#endif /*#ifndef IFXSCU_CFG_SYS_PLL_20MHZ_400MHZ */

#ifndef IFXSCU_CFG_WAIT_INITIAL_STEP_20MHZ_400MHZ
#define IFXSCU_CFG_WAIT_INITIAL_STEP_20MHZ_400MHZ 0.000200F
#endif /*#ifndef IFXSCU_CFG_WAIT_INITIAL_STEP_20MHZ_400MHZ */

#ifndef IFXSCU_CFG_PLL_STEPS_20MHZ_400MHZ
/**** Macro for Pll step for profile with 20MHz Crystal and 400MHz target (fDCO= 400MHz)*/
#define IFXSCU_CFG_PLL_STEPS_20MHZ_400MHZ  IFXSCU_CFG_PLL_STEPS_FDCO_400MHZ_TO_TARGET_400MHZ
#endif /*#ifndef IFXSCU_CFG_PLL_STEPS_20MHZ_400MHZ */
...
/************** Target = 400MHz *****************/
 ...
 #ifndef IFXSCU_CFG_SYS_PLL_25MHZ_400MHZ
/**** Macro for Initial Pll step, for profile with 25MHz Crystal and 400MHz target (fDCO= 400)*/
#define IFXSCU_CFG_SYS_PLL_25MHZ_400MHZ                            \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial }*/            \
    {(1 - 1), (16 - 1), (4 - 1)}
#endif /*#ifndef IFXSCU_CFG_SYS_PLL_25MHZ_400MHZ */

#ifndef IFXSCU_CFG_WAIT_INITIAL_STEP_25MHZ_400MHZ
#define IFXSCU_CFG_WAIT_INITIAL_STEP_25MHZ_400MHZ 0.000200F
#endif /*#ifndef IFXSCU_CFG_WAIT_INITIAL_STEP_25MHZ_400MHZ */

#ifndef IFXSCU_CFG_PLL_STEPS_25MHZ_400MHZ
/**** Macro for Pll step for profile with 25MHz Crystal and 400MHz target (fDCO= 400MHz)*/
#define IFXSCU_CFG_PLL_STEPS_25MHZ_400MHZ  IFXSCU_CFG_PLL_STEPS_FDCO_400MHZ_TO_TARGET_400MHZ
#endif /*#ifndef IFXSCU_CFG_PLL_STEPS_25MHZ_400MHZ */
...
/************** Target = 400MHz *****************/
 ...
 #ifndef IFXSCU_CFG_SYS_PLL_40MHZ_400MHZ
/**** Macro for Initial Pll step, for profile with 40MHz Crystal and 400MHz target (fDCO= 400)*/
#define IFXSCU_CFG_SYS_PLL_40MHZ_400MHZ                            \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial }*/            \
    {(1 - 1), (10 - 1), (4 - 1)}
#endif /*#ifndef IFXSCU_CFG_SYS_PLL_40MHZ_400MHZ */

#ifndef IFXSCU_CFG_WAIT_INITIAL_STEP_40MHZ_400MHZ
#define IFXSCU_CFG_WAIT_INITIAL_STEP_40MHZ_400MHZ 0.000200F
#endif /*#ifndef IFXSCU_CFG_WAIT_INITIAL_STEP_40MHZ_400MHZ */

#ifndef IFXSCU_CFG_PLL_STEPS_40MHZ_400MHZ
/**** Macro for Pll step for profile with 40MHz Crystal and 400MHz target (fDCO= 400MHz)*/
#define IFXSCU_CFG_PLL_STEPS_40MHZ_400MHZ  IFXSCU_CFG_PLL_STEPS_FDCO_400MHZ_TO_TARGET_400MHZ
#endif /*#ifndef IFXSCU_CFG_PLL_STEPS_40MHZ_400MHZ */
...
/**************** Fsource = Fpll0 = 400MHz **********************************************************/

#ifndef IFXSCU_CFG_400MHZ_DIVIDER_OPTION_SCALED_UP_400MHZ
#define IFXSCU_CFG_400MHZ_DIVIDER_OPTION_SCALED_UP_400MHZ   (1)
#endif /*#ifndef IFXSCU_CFG_400MHZ_DIVIDER_OPTION_SCALED_UP_400MHZ */

#ifndef IFXSCU_CFG_400MHZ_DIVIDER_OPTION_ALIGNED_TO_300MHZ
#define IFXSCU_CFG_400MHZ_DIVIDER_OPTION_ALIGNED_TO_300MHZ  (2)
#endif /*#ifndef IFXSCU_CFG_400MHZ_DIVIDER_OPTION_ALIGNED_TO_300MHZ */

#ifndef IFXSCU_CFG_400MHZ_DIVIDER_OPTION
#define IFXSCU_CFG_400MHZ_DIVIDER_OPTION IFXSCU_CFG_400MHZ_DIVIDER_OPTION_SCALED_UP_400MHZ
#endif /*#ifndef IFXSCU_CFG_400MHZ_DIVIDER_OPTION */


#if (IFXSCU_CFG_400MHZ_DIVIDER_OPTION == IFXSCU_CFG_400MHZ_DIVIDER_OPTION_SCALED_UP_400MHZ)

/************** CCUCON0 : STMDIV  (Output : fSTM)**************/
/* Target = 133.333 MHz AND Source = Fsource0 */
#ifndef IFXSCU_CFG_STMDIV_400MHZ
#define IFXSCU_CFG_STMDIV_400MHZ             (3)
#endif /*#ifndef IFXSCU_CFG_STMDIV_400MHZ */

/************** CCUCON0 : GTMDIV  (Output : fGTM)**************/
/* Target = 266.666 MHz AND Source = fSPB * 2 (special case when GTMDIV=1) */
#ifndef IFXSCU_CFG_GTMDIV_400MHZ
#define IFXSCU_CFG_GTMDIV_400MHZ             (1)
#endif /*#ifndef IFXSCU_CFG_GTMDIV_400MHZ */

/************** CCUCON0 : SRIDIV  (Output : fSRI)**************/
/* Target = 400 MHz AND Source = Fsource0 */
#ifndef IFXSCU_CFG_SRIDIV_400MHZ
#define IFXSCU_CFG_SRIDIV_400MHZ             (1)
#endif /*#ifndef IFXSCU_CFG_SRIDIV_400MHZ */

/************** CCUCON0 : SPBDIV  (Output : fSPB)**************/
/* Target = 133.333 MHz AND Source = Fsource0 */
#ifndef IFXSCU_CFG_SPBDIV_400MHZ
#define IFXSCU_CFG_SPBDIV_400MHZ             (3)
#endif /*#ifndef IFXSCU_CFG_SPBDIV_400MHZ */

/************** CCUCON0 : BBBDIV  (Output : fBBB)**************/
/* Target = 200 MHz AND Source = Fsource0 */
#ifndef IFXSCU_CFG_BBBDIV_400MHZ
#define IFXSCU_CFG_BBBDIV_400MHZ             (2)
#endif /*#ifndef IFXSCU_CFG_BBBDIV_400MHZ */

/************** CCUCON0 : FSIDIV  (Output : fFSI)**************/
/* Target = 133.333 MHz AND Source = Fsri */
#ifndef IFXSCU_CFG_FSIDIV_400MHZ
#define IFXSCU_CFG_FSIDIV_400MHZ             (IFXSCU_CFG_SRIDIV_400MHZ * 3)
#endif /*#ifndef IFXSCU_CFG_FSIDIV_400MHZ */

/************** CCUCON0 : FSI2DIV  (Output : fFSI2)**************/
/* Target = 400 MHz AND Source = Fsri */
#ifndef IFXSCU_CFG_FSI2DIV_400MHZ
#define IFXSCU_CFG_FSI2DIV_400MHZ            (IFXSCU_CFG_SRIDIV_400MHZ * 1)
#endif /*#ifndef IFXSCU_CFG_FSI2DIV_400MHZ */

/************** CCUCON5 : GETHDIV  (Output : fGETH)**************/
/* Target = 200 MHz AND Source = Fsource0 */
#ifndef IFXSCU_CFG_GETHDIV_400MHZ
#define IFXSCU_CFG_GETHDIV_400MHZ            (2)
#endif /*#ifndef IFXSCU_CFG_GETHDIV_400MHZ */

/************** CCUCON5 : MCANHDIV  (Output : fMCANH)**************/
/* Target = 133.333 MHz AND Source = Fsource0 */
#ifndef IFXSCU_CFG_MCANHDIV_400MHZ
#define IFXSCU_CFG_MCANHDIV_400MHZ           (3)
#endif /*#ifndef IFXSCU_CFG_MCANHDIV_400MHZ */

/************** CCUCON5 : ADASDIV  (Output : fADAS)**************/
/* Target = 400 MHz AND Source = Fsource0 */
#ifndef IFXSCU_CFG_ADASDIV_400MHZ
#define IFXSCU_CFG_ADASDIV_400MHZ            (1)
#endif /*#ifndef IFXSCU_CFG_ADASDIV_400MHZ */

#elif (IFXSCU_CFG_400MHZ_DIVIDER_OPTION == IFXSCU_CFG_400MHZ_DIVIDER_OPTION_ALIGNED_TO_300MHZ)

/************** CCUCON0 : STMDIV  (Output : fSTM)**************/
/* Target = 100 MHz AND Source = Fsource0 */
#ifndef IFXSCU_CFG_STMDIV_400MHZ
#define IFXSCU_CFG_STMDIV_400MHZ             (4)
#endif /*#ifndef IFXSCU_CFG_STMDIV_400MHZ */

/************** CCUCON0 : GTMDIV  (Output : fGTM)**************/
/* Target = 200 MHz AND Source = Fsource0 */
#ifndef IFXSCU_CFG_GTMDIV_400MHZ
#define IFXSCU_CFG_GTMDIV_400MHZ             (2)
#endif /*#ifndef IFXSCU_CFG_GTMDIV_400MHZ */
...
/* Target = 100 MHz AND Source = Fsource0 */
#ifndef IFXSCU_CFG_SPBDIV_400MHZ
#define IFXSCU_CFG_SPBDIV_400MHZ             (4)
#endif /*#ifndef IFXSCU_CFG_SPBDIV_400MHZ */
...
/* Target = 100 MHz AND Source = Fsource0 */
#ifndef IFXSCU_CFG_MCANHDIV_400MHZ
#define IFXSCU_CFG_MCANHDIV_400MHZ           (4)
#endif /*#ifndef IFXSCU_CFG_MCANHDIV_400MHZ */
...
#else
#error "Wrong IFXSCU_CFG_400MHZ_DIVIDER_OPTION configuration!"
#error "Supported values are IFXSCU_CFG_400MHZ_DIVIDER_OPTION_SCALED_UP_400MHZ and IFXSCU_CFG_400MHZ_DIVIDER_OPTION_ALIGNED_TO_300MHZ."
#endif /*#if (IFXSCU_CFG_400MHZ_DIVIDER_OPTION == ...) */

/************** CCUCON6 : CPU0DIV  (Output : fCPU0)**************/
/* Target = 400 MHz AND Source = Fsri - common to both options */
#ifndef IFXSCU_CFG_CPU0DIV_400MHZ
#define IFXSCU_CFG_CPU0DIV_400MHZ             (0)
#endif /*#ifndef IFXSCU_CFG_CPU0DIV_400MHZ */

/************** CCUCON7 : CPU1DIV  (Output : fCPU1)**************/
/* Target = 400 MHz AND Source = Fsri */
#ifndef IFXSCU_CFG_CPU1DIV_400MHZ
#define IFXSCU_CFG_CPU1DIV_400MHZ             (0)
#endif /*#ifndef IFXSCU_CFG_CPU1DIV_400MHZ */

/************** CCUCON8 : CPU2DIV  (Output : fCPU2)**************/
/* Target = 400 MHz AND Source = Fsri */
#ifndef IFXSCU_CFG_CPU2DIV_400MHZ
#define IFXSCU_CFG_CPU2DIV_400MHZ             (0)
#endif /*#ifndef IFXSCU_CFG_CPU2DIV_400MHZ */

/************** CCUCON9 : CPU3DIV  (Output : fCPU3)**************/
/* Target = 400 MHz AND Source = Fsri */
#ifndef IFXSCU_CFG_CPU3DIV_400MHZ
#define IFXSCU_CFG_CPU3DIV_400MHZ             (0)
#endif /*#ifndef IFXSCU_CFG_CPU3DIV_400MHZ */

/************** CCUCON10 : CPU4DIV  (Output : fCPU4)**************/
/* Target = 400 MHz AND Source = Fsri */
#ifndef IFXSCU_CFG_CPU4DIV_400MHZ
#define IFXSCU_CFG_CPU4DIV_400MHZ             (0)
#endif /*#ifndef IFXSCU_CFG_CPU4DIV_400MHZ */

/************** CCUCON11 : CPU5DIV  (Output : fCPU5)**************/
/* Target = 400 MHz AND Source = Fsri */
#ifndef IFXSCU_CFG_CPU5DIV_400MHZ
#define IFXSCU_CFG_CPU5DIV_400MHZ             (0)
#endif /*#ifndef IFXSCU_CFG_CPU5DIV_400MHZ */
