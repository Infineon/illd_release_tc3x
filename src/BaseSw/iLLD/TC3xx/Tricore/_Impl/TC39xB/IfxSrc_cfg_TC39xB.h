...
#ifndef IFXSRC_CFG_TC39XB_H
#define IFXSRC_CFG_TC39XB_H 1
...
typedef enum
{
    ...
    IfxSrc_Tos_cpu4 = 5,  /**< \brief CPU4 interrupt service provider, which handles the interrupt service request. */
    IfxSrc_Tos_cpu5 = 6   /**< \brief CPU5 interrupt service provider, which handles the interrupt service request. */
} IfxSrc_Tos;

/** \} */

#endif /* IFXSRC_CFG_TC39XB_H */
