...
#ifndef IFXSTM_CFG_TC39XB_H
#define IFXSTM_CFG_TC39XB_H 1
...
typedef enum
{
    ...
    IfxStm_Index_3,          /**< \brief STM index 3  */
    IfxStm_Index_4,          /**< \brief STM index 4  */
    IfxStm_Index_5           /**< \brief STM index 5  */
} IfxStm_Index;
