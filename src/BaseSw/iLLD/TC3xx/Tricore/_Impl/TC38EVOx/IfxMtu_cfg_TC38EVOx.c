...
#if defined DEVICE_TC38EVOX
#include "IfxMtu_cfg_TC38EVOx.h"
...
const IfxMtu_SramItem           IfxMtu_sramTable[IFXMTU_NUM_MBIST_TABLE_ITEMS] = {
    ...
    {1 * 1, 32,  7,  0, 1}, /**< \brief IfxMtu_MbistSel_mcan3 */
    {1 * 1, 32,  7,  0, 1}, /**< \brief IfxMtu_MbistSel_mcan4 */
