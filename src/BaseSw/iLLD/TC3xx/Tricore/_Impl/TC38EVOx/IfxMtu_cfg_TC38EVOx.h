...
#ifndef IFXMTU_CFG_TC38EVOX_H
#define IFXMTU_CFG_TC38EVOX_H 1
...
typedef enum
{
    ...
    IfxMtu_MbistSel_mcan3       = 36,
    IfxMtu_MbistSel_mcan4       = 37,
