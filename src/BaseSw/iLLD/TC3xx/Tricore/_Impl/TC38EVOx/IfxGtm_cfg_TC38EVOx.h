...
#ifndef IFXGTM_CFG_TC38EVOX_H
#define IFXGTM_CFG_TC38EVOX_H 1
 ...
 */
#define IFXGTM_NUM_MCS_OBJECTS          (7)

/** \brief Number of Parameter Storage Modules
 */
#define IFXGTM_NUM_PSM_OBJECTS          (2)
 ...
 */
#define IFXGTM_NUM_SPE_OBJECTS          (4)

/** \brief Number of Cluster Configuration Module
 */
#define IFXGTM_NUM_CCM_OBJECTS          (9)
...
#define IFXGTM_NUM_TIM_OBJECTS          (7)

/** \brief number of TIM channels.
 */
#define IFXGTM_NUM_TIM_CHANNELS         (8)

/** \brief number of TBU channels.
 */
#define IFXGTM_NUM_TBU_CHANNELS         (4)
