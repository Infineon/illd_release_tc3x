...
#ifndef IFXFLASH_CFG_TC38EVOX_H
#define IFXFLASH_CFG_TC38EVOX_H 1
...
/** \brief
 */
#define IFXFLASH_PFLASH_NUM_LOG_SECTORS                  ((192 * 4))

#define IFXFLASH_PFLASH_NUM_PHYSICAL_SECTORS             (3 * 4)
...
/** \brief p flash size
 */
#define IFXFLASH_PFLASH_SIZE                             (0x00C00000)
 ...
 */
#define IFXFLASH_PFLASH_BUSY_STATUS_MASK                 (0x3F)
