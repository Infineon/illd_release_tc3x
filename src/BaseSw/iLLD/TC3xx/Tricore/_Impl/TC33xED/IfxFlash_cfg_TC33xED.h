...
#ifndef IFXFLASH_CFG_TC33XED_H
#define IFXFLASH_CFG_TC33XED_H 1
...
/** \brief p flash end
 */
#define IFXFLASH_PFLASH_END                              (IFXFLASH_PFLASH_START + 0x200000 - 1)

/** \brief
 */
#define IFXFLASH_PFLASH_NUM_LOG_SECTORS                  ((128 * 1))

#define IFXFLASH_PFLASH_NUM_PHYSICAL_SECTORS             (2 * 1)
...
/** \brief p flash size
 */
#define IFXFLASH_PFLASH_SIZE                             (0x00200000)
