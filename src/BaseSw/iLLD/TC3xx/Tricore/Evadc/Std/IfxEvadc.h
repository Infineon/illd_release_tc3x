 ...
 * Defined Ifx_EVADC_GLOB_RCR.B.DRCTR
 */
typedef enum
{
...
/** \brief Service Request Node Pointer Global Result
 * Defined in Ifx_EVADC_GLOB_EVNP.B.REV0NP
 */
typedef enum
{
    IfxEvadc_GlobalResultServiceRequestNodePointer_0  = 0,   /**< \brief Select shared service request line 0 of common service request group 0 */
	IfxEvadc_GlobalResultServiceRequestNodePointer_1  = 1,   /**< \brief Select shared service request line 1 of common service request group 0 */
	IfxEvadc_GlobalResultServiceRequestNodePointer_2  = 2,   /**< \brief Select shared service request line 2 of common service request group 0 */
	IfxEvadc_GlobalResultServiceRequestNodePointer_3  = 3,   /**< \brief Select shared service request line 3 of common service request group 0 */
	IfxEvadc_GlobalResultServiceRequestNodePointer_4  = 4,   /**< \brief Select shared service request line 0 of common service request group 1 */
	IfxEvadc_GlobalResultServiceRequestNodePointer_5  = 5,   /**< \brief Select shared service request line 1 of common service request group 1 */
	IfxEvadc_GlobalResultServiceRequestNodePointer_6  = 6,   /**< \brief Select shared service request line 2 of common service request group 1 */
	IfxEvadc_GlobalResultServiceRequestNodePointer_7  = 7    /**< \brief Select shared service request line 3 of common service request group 1 */
} IfxEvadc_GlobalResultServiceRequestNodePointer;
 ...
 * Defined in Ifx_EVADC_GLOB_RCR.B.WFR
 */
typedef enum
{
