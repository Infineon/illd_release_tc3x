...
#if defined(DEVICE_TC37X) || defined(DEVICE_TC37XED)  || defined(DEVICE_TC39XB)

    /* Configure k3 divider setting (PERPLLCON1.K3DIV) to 0x0 or 0x1, before changing PERPLLCON0.DIVBY value */
    
    SCU_PERPLLCON1.B.K3DIV = 0x1U;
...
#if defined(DEVICE_TC37X) || defined(DEVICE_TC37XED)  || defined(DEVICE_TC39XB)
 /* configure the K3DIV value as per user configuration */
   ...
   SCU_PERPLLCON1.B.K3DIV = pllsParamCfg->perPllConfig.k3Divider;
