...
/**
 * \brief Initializes the TPwm configuration structure with default values.
 *
...
/**
 * \brief Initializes the TPWM module with the provided configuration.
 *
 * \param[inout] tPwm   Pointer to the IfxCcu6_TPwm module handle.
...
/**
 * \brief Initializes the Timer13 module of the CCU6 TPWM with the provided configuration.
 *
 * \param[inout] config Pointer to the configuration structure to be initialized.
 *
 * \retval None
 */
IFX_EXTERN void IfxCcu6_TPwm_initTimer13(const IfxCcu6_TPwm_Config *config);

/**
 * \brief Initializes the Timer12 module of the CCU6 TPWM with the provided configuration.
 *
 * \param[inout] config Pointer to the configuration structure to be initialized.
 *
 * \retval None
 */
IFX_EXTERN void IfxCcu6_TPwm_initTimer12(const IfxCcu6_TPwm_Config *config);
 ...
 * \retval None
 */
IFX_EXTERN void IfxCcu6_TPwm_initPins(const IfxCcu6_TPwm_Pins *pins);
 ...
 * \retval None
 */
IFX_EXTERN void IfxCcu6_TPwm_initInterrupt(Ifx_CCU6 *ccu6, IfxCcu6_TPwm_InterruptConfig interrupt);

/**
 * \brief Pauses the triggered PWM operation.
 *
 * \param[inout] tPwm Pointer to the IfxCcu6_TPwm module handle.
 *
 * \retval None
...
/**
 * \brief Resumes the operation of the triggered PWM module, allowing it to continue execution from its previous state.
 *
 * \param[inout] tPwm Pointer to the IfxCcu6_TPwm module handle.
 *
 * \retval None
...
/**
 * \brief Stops the triggered PWM operation.
 *
 * This function halts the PWM signal generation that was previously triggered.
 *
 * \param[inout] tPwm Pointer to the IfxCcu6_TPwm module handle.
 *
 * \retval None
