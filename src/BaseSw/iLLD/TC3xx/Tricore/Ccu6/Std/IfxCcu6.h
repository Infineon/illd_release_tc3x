...
/**
 * \brief Clears the counters of the specified timers (T12 and/or T13) in the CCU6 module.
 *
 * \param[inout] ccu6 Pointer to the base of CCU6 registers.
 * \param[in]    t12  Boolean flag to enable or disable clearing of the Timer12 counter.
 * \param[in]    t13  Boolean flag to enable or disable clearing of the Timer13 counter.
 *
 * \retval None
 */
...
/**
 * \brief Clears the specified interrupt status flag for the CCU6 module.
 *
 * \param[inout] ccu6    Pointer to the base of CCU6 registers.
 * \param[in]    source  Interrupt source selection.
 *                       Range: \ref IfxCcu6_InterruptSource
 *
 * \retval None
 */
...
/**
 * \brief Returns a pointer to the Timer 12 (T12) register of the CCU6 module.
 *
 * \param[in] ccu6  Pointer to the base of CCU6 registers
 *
 * \retval uint32 Pointer to the T12 timer register.
 *         Range: \ref 0 to 0xFFFF.
 */
IFX_INLINE volatile uint32 *IfxCcu6_getT12TimerPointer(Ifx_CCU6 *ccu6);

/**
 * \brief Checks if the CCU6 module is enabled.
 *
 * \param[in] ccu6  Pointer to the base of CCU6 registers
 *
 * \retval TRUE If the CCU6 module is enabled.
 *         FALSE If the CCU6 module is disabled.
 */
IFX_INLINE boolean IfxCcu6_isModuleEnabled(Ifx_CCU6 *ccu6);

/**
 * \brief Checks if the T12 one notification is active.
 *
 * \param[in] ccu6  Pointer to the base of CCU6 registers
 *
 * \retval TRUE If the T12 one notification is active.
 *         FALSE If the T12 one notification is not active.
 */
IFX_INLINE boolean IfxCcu6_isT12OneNotification(Ifx_CCU6 *ccu6);

/**
 * \brief Checks if the T12 period notification is active.
 *
 * \param[in] ccu6  Pointer to the base of CCU6 registers
 *
 * \retval TRUE if the T12 period notification is active, FALSE otherwise.
 */
IFX_INLINE boolean IfxCcu6_isT12PeriodNotification(Ifx_CCU6 *ccu6);

/**
 * \brief Indicates whether a T13 compare notification is currently active.
 *
 * \param[in] ccu6  Pointer to the base of CCU6 registers.
 *
 * \retval TRUE  If T13 compare notification is active.
 *         FALSE If T13 compare notification is not active.
 */
IFX_INLINE boolean IfxCcu6_isT13CompareNotification(Ifx_CCU6 *ccu6);

/**
 * \brief Sets the input event that triggers a counting action for the specified timer (T12 or T13).
 *
 * \param[inout] ccu6  Pointer to the base of CCU6 registers.
 * \param[in]    timer Timer selection (T12 or T13).
 *                     Range: \ref IfxCcu6_TimerId
 * \param[in]    mode  Input event leading to a counting action.
 *                     Range: \ref IfxCcu6_CountingInputMode
 *
 * \retval None
 */
...
/**
 * \brief Configures the current Hall pattern for multichannel mode by writing to the shadow register.
 *
 * \param[inout] ccu6     Pointer to the base of CCU6 registers.
 * \param[in]    pattern  Current Hall pattern to be set.
 *                        Range: 0 to 6
 *
 * \retval None
 */
 ...
 *
 * \param[inout] ccu6  Pointer to the base of CCU6 registers.
 * \param[in]    value Value of the dead time to be induced
 *                     Range: 0 to 0x7F
 *
 * \retval None
 */
 ...
 *
 * \param[inout] ccu6     Pointer to the base of CCU6 registers
 * \param[in]    pattern  Expected hall pattern
 *                        Range: 0 to 6
 *
 * \retval None
 */
...
/**
 * \brief Configures the external trigger mode for setting the run bit of a specified timer.
 *
 * \param[inout] ccu6  Pointer to the base of CCU6 registers.
 * \param[in]    timer Timer selection.
 *                     Range: \ref IfxCcu6_TimerId
 * \param[in]    mode  External trigger mode.
 *                     Range: \ref IfxCcu6_ExternalTriggerMode
 *
 * \retval None
 */
...
/**
 * \brief Sets the source for the sampling of the Hall input pattern and the comparison to the current and the expected Hall pattern bit fields.
 *
 * \param[inout] ccu6  Pointer to the base of CCU6 registers.
 * \param[in]    mode  Hall sensor input trigger event.
 *                     Range: \ref IfxCcu6_HallSensorTriggerMode
 *
 * \retval None
 */
...
/**
 * \brief Sets the input clock frequency for the specified timer (T12 or T13).
 *
 * \param[inout] ccu6      Pointer to the base of CCU6 registers.
 * \param[in]    timer     Timer selection.
 *                         Range: \ref IfxCcu6_TimerId
 * \param[in]    frequency Input clock frequency selection.
 *                         Range: \ref IfxCcu6_TimerInputClock
 *
 * \retval None
 */
...
/**
 * \brief Sets the specified interrupt status flag for the CCU6 module.
 *
 * \param[inout] ccu6   Pointer to the base of CCU6 registers.
 * \param[in]    source Interrupt source selection.
 *                      Range: \ref IfxCcu6_InterruptSource
...
/**
 * \brief Configures the PWM output pattern for multichannel mode.
 *
 * \param[inout] ccu6     Pointer to the base of CCU6 registers.
 * \param[in]    pattern  Output pattern for the multichannel mode.
 *                        Range: 0 to 0x3F.
 *
 * \retval None
 */
...
/**
 * \brief Configures the trigger request source (next multi-channel event) for the shadow transfer MCM_ST
 *
 * \param[inout] ccu6  Pointer to the base of CCU6 registers.
 * \param[in]    mode  Trigger request source (next multi-channel event) for the shadow transfer MCM_ST.
 *                     Range: \ref IfxCcu6_MultiChannelSwitchingSelect
 *
 * \retval None
 */
 ...
 *
 * \param[inout] ccu6  Pointer to the base of CCU6 registers.
 * \param[in]    sync  Synchronization mechanism of the shadow transfer event MCM_ST.
 *                     Range: \ref IfxCcu6_MultiChannelSwitchingSync
 *
 * \retval None
 */
...
/**
 * \brief Configures the passive state for the specified capture compare output channel.
 *
 * \param[inout] ccu6        Pointer to the base of CCU6 registers.
 * \param[in]    channelOut  Capture compare output selection.
 *                           Range: \ref IfxCcu6_ChannelOut
 * \param[in]    state       FALSE: Passive state when CC6xST == 0\n
...
/**
 * \brief Enables or disables the single-shot mode for Timer12 (T12) and Timer13 (T13) individually or together.
 *
 * \param[inout] ccu6 Pointer to the base of CCU6 registers.
 * \param[in]    t12  Enable/Disable flag for Timer12 single-shot mode
 *                    Range: TRUE = enable, FALSE = disable
 * \param[in]    t13  Enable/Disable flag for Timer13 single-shot mode
 *                    Range: TRUE = enable, FALSE = disable
 *
 * \retval None
 */
 ...
 *
 * \param[inout] ccu6    Pointer to the base of CCU6 registers
 * \param[in]    channel Timer12 Capture compare channel number.
 *                       Range: \ref IfxCcu6_T12Channel
 * \param[in]    mode    The operating mode for the T12 channel.
 *                       Range: \ref IfxCcu6_T12ChannelMode
 *
 * \retval None
 */
...
/**
 * \brief Sets the operating mode of Timer 12 in the CCU6 module.
 *
 * \param[inout] ccu6  Pointer to the base of CCU6 registers.
 * \param[in]    mode  Operating mode of Timer 12.
 *                     Range: \ref IfxCcu6_T12CountMode
 *
 * \retval None
 */
...
/**
 * \brief Sets the 16-bit counter value of Timer12 in the CCU6 module.
 *
 * \param[inout] ccu6  Pointer to the base of CCU6 registers.
 * \param[in]    value 16-bit counter value to be set for Timer12.
 *               Range: 0 to 0xFFFF
 *
 ...
 *
 * \param[inout] ccu6  Pointer to the base of CCU6 registers
 * \param[in]    value Period value to be set for Timer12
 *                     Range: 0 to 0xFFFF
 *
 * \retval None
 */
 ...
 *
 * \param[inout] ccu6  Pointer to the base of CCU6 registers
 * \param[in]    value Compare value to be set for Timer13
 *                     Range: 0 to 0xFFFF
 *
 * \retval None
 */
...
/**
 * \brief Sets the 16-bit counter value for Timer13 in the CCU6 module.
 *
 * \param[inout] ccu6  Pointer to the base of CCU6 registers.
 ...
 *
 * \param[inout] ccu6  Pointer to the base of CCU6 registers
 * \param[in]    value Period value to be set for Timer13
 *                     Range: 0 to 0xFFFF
 *
 * \retval None
 */
...
/**
 * \brief Sets the direction of the Timer13 trigger event for the CCU6 module.
 *
 * \param[inout] ccu6      Pointer to the base of CCU6 registers.
 * \param[in]    direction T13 trigger event direction.
 *                         Range: \ref IfxCcu6_T13TriggerDirection
 *
 * \retval None
 */
 ...
 *
 * \param[inout] ccu6  Pointer to the base of CCU6 registers
 * \param[in]    mode  The trigger event to start T13.
 *                     Range: \ref IfxCcu6_T13TriggerEvent
 *
 * \retval None
 */
 ...
 *
 * \param[inout] ccu6  Pointer to the base of CCU6 registers.
 * \param[in]    mode  Trap mode selection
 *                     Range: \ref IfxCcu6_TrapMode
 *
 * \retval None
 */
...
/**
 * \brief Sets the behavior of the selected outputs when leaving the trap state after the trap condition has become inactive again.
 *
 * \param[inout] ccu6  Pointer to the base of CCU6 registers.
 * \param[in]    state  Trap state selection.
 *               Range: \ref IfxCcu6_TrapState
 *
 * \retval None
 */
...
/**
 * \brief Starts the CCU6 timers (T12 and T13) individually or together based on the selection.
 *
 * \param[inout] ccu6 Pointer to the base of CCU6 registers.
 * \param[in]    t12  Timer12 start choice
 *                    Range: TRUE = enable, FALSE = disable
 * \param[in]    t13  Timer13 start choice
 *                    Range: TRUE = enable, FALSE = disable
 *
 * \retval None
 */
...
/**
 * \brief Stops the specified timers (T12, T13) individually or together based on the selection.
 *
 * \param[inout] ccu6 Pointer to the base of CCU6 registers.
 * \param[in]    t12  Timer12 stop choice
 *                    Range: TRUE = enable, FALSE = disable
 * \param[in]    t13  Timer13 stop choice
 *                    Range: TRUE = enable, FALSE = disable
 *
 * \retval None
 */
...
/**
 * \brief Updates the hall pattern (current hall, expected hall, modulation output) in a single write.
 *
 * \param[inout] ccu6          Pointer to the base of CCU6 registers.
 * \param[in]    currentHall   Current hall pattern
 *                             Range: 0 to 6
 * \param[in]    expectedHall  Expected hall pattern
 *                             Range: 0 to 6
 * \param[in]    output Output pattern for the multichannel mode
 *                             Range: 0 to 0x3F
 *
 * \retval None
 */
...
/**
 * \brief Connects a selected trigger to a specific output line of the CCU6 module.
 *
 * \param[in] ccu6            Pointer to the base of CCU6 registers.
 * \param[in] outputLine      Output line to which the trigger will be connected.
 *                            Range: \ref IfxCcu6_TrigOut
 * \param[in] selectedTrigger Trigger to be connected.
 *                            Range: \ref IfxCcu6_TrigSel
 *
 * \retval None
 */
...
/**
 * \brief Routes the specified interrupt source to the selected service request output.
 *
 * \param[inout] ccu6           Pointer to the base of CCU6 registers.
 * \param[in]    source         Interrupt source selection.
 *                              Range: \ref IfxCcu6_InterruptSource
 * \param[in]    serviceRequest Selection of service request outputs.
 *                              Range: \ref IfxCcu6_ServiceRequest
 *
 * \retval None
 */
 ...
 * \param[in]    channelOut Capture compare output selection
 *                          Range: \ref IfxCcu6_ChannelOut
 * \param[in]    state      Passive level state:
 *                          Range: TRUE = enable, FALSE = disable
 *
 * \retval None
 */
 ...
 * \param[in]    channel Timer12 Capture compare channel number.
 *                       Range: \ref IfxCcu6_T12Channel
 * \param[in]    state   Capture/compare state selection.
 *                       Range: \ref IfxCcu6_CaptureCompareState
 *
 * \retval None
 */
 ...
 *
 * \param[inout]  ccu6       Pointer to the base of CCU6 registers.
 * \param[inout]  frequency  Requested timer frequency in Hz.
 * \param[in]     period     Period value to be configured.
 *                           Range: 0 to 0xFFFF
 * \param[in]     countMode  Counting mode of Timer12.
 *                           Range: \ref IfxCcu6_T12CountMode
 *
 * \retval Zero,     if the function failed to fulfill requested frequency and resolution.
...
/**
 * \brief Selects the actual input signal for the Timer 12 inputs.
 *
 * \param[inout] ccu6      Pointer to the base of CCU6 registers.
 * \param[in]    extInput  External input signal for Timer 12.
 *
 * \retval None
 */
...
/**
 * \brief Sets the software-control state for Timer13 channel state bits CC63ST.
 *
 * \param[inout] ccu6  Pointer to the base of CCU6 registers.
 * \param[in]    state Capture/compare state selection.
 *                     Range: \ref IfxCcu6_CaptureCompareState
 ...
 *                          Range: 0 to 0xFFFF
 *
 * \retval float32 Zero,     Function failed to fulfill the requested frequency and resolution.
 *                 Positive, value Function successfully configured Timer 13 to a frequency close to the requested value.
 */
IFX_EXTERN float32 IfxCcu6_setT13Frequency(Ifx_CCU6 *ccu6, float32 frequency, Ifx_TimerValue period);

/**
 * \brief Configures the external input signal source for Timer 13.
 *
 * \param[inout] ccu6     Pointer to the base of CCU6 registers.
 * \param[in]    extInput Pointer to the external input signal configuration for Timer 13. This parameter specifies the input signal to be selected.
 *
 * \retval None
 */
...
/**
 * \brief Gets the status of the dead time generation for a specific capture compare channel of Timer T12.
 *
 * \param[in] ccu6     Pointer to the base of CCU6 registers.
 * \param[in] channel  Timer12 Capture compare channel number.
 *                     Range: \ref IfxCcu6_T12Channel
 *
 * \retval TRUE  Dead time generation is active for the specified channel.
 *         FALSE Dead time generation is not active for the specified channel.
 */
IFX_INLINE boolean IfxCcu6_getDeadTimeStatus(Ifx_CCU6 *ccu6, IfxCcu6_T12Channel channel);

/**
 * \brief Returns the sampled state of the Hall pattern input for the specified Timer12 capture/compare channel.
 *
 * \param[in] ccu6     Pointer to the base of CCU6 registers
 * \param[in] channel  Timer12 Capture compare channel number.
 *                     Range: \ref IfxCcu6_T12Channel
 *
 * \retval TRUE  The input CCPOSx has been sampled as 0.
 ...
 *         FALSE The interrupt flag is cleared.
 */
IFX_INLINE boolean IfxCcu6_getInterruptStatusFlag(Ifx_CCU6 *ccu6, IfxCcu6_InterruptSource source);

/**
 * \brief Checks if the multi-channel mode functionality is available for the specified CCU6 instance.
 *
 * \param[in] ccu6  Pointer to the base of CCU6 registers.
 *
 * \retval TRUE  Multi-channel mode functionality is available.
 *         FALSE Multi-channel mode functionality is not available.
 */
 ...
 * \param[in] ccu6  Pointer to the base of CCU6 registers
 *
 * \retval FALSE Shadow transfer MCM_ST is not requested.
 *         TRUE  Shadow transfer MCM_ST is requested, but has not yet been executed.
 */
 ...
 *                  Range: \ref IfxCcu6_TimerId
 *
 * \retval Status of the shadow transfer enable (TRUE: enabled, FALSE: disabled).
 */
 ...
 *                    Range: \ref IfxCcu6_T12Channel
 *
 * \retval TRUE  The capture/compare channel is active.
 *         FALSE The capture/compare channel is inactive.
 */
 ...
 * \param[in] ccu6  Pointer to the base of CCU6 registers
 *
 * \retval IfxCcu6_T12CountDirection.
 *         Range: \ref IfxCcu6_T12CountDirection.
 */
 ...
 * \param[in] ccu6  Pointer to the base of CCU6 registers
 *
 * \retval TRUE  The Timer13 capture/compare channel CC63ST is active.
 *         FALSE The Timer13 capture/compare channel CC63ST is inactive.
 */
IFX_INLINE boolean IfxCcu6_getT13CaptureCompareState(Ifx_CCU6 *ccu6);

/**
 * \brief Checks the availability status of the specified CCU6 timer block (T12 or T13).
 *
 * \param[in] ccu6   Pointer to the base of CCU6 registers.
 * \param[in] timer  Timer selection.
 *                   Range: \ref IfxCcu6_TimerId
 *
 * \retval TRUE  The selected timer block is available.
 *         FALSE The selected timer block is not available.
 */
IFX_INLINE boolean IfxCcu6_getTimerAvailabilityStatus(Ifx_CCU6 *ccu6, IfxCcu6_TimerId timer);

/**
 * \brief Gets the run status of the specified timer (T12 or T13).
 *
 * \param[in] ccu6  Pointer to the base of CCU6 registers.
 * \param[in] timer Timer selection.
 *                  Range: \ref IfxCcu6_TimerId
 *
 * \retval IfxCcu6_TimerRunStatus.
 *         Range: \ref IfxCcu6_TimerRunStatus.
 */
IFX_INLINE IfxCcu6_TimerRunStatus IfxCcu6_getTimerRunStatus(Ifx_CCU6 *ccu6, IfxCcu6_TimerId timer);

/**
 * \brief Checks if the CCU6 module is in a suspended state.
 *
 * \param[in] ccu6  Pointer to the base of CCU6 registers.
 *
 * \retval TRUE if the module is suspended, FALSE if the module is active.
 */
 ...
 *
 * \note: The api works only when the OCDS is enabled and in Supervisor Mode. When OCDS is
 *        disabled the OCS suspend control is ineffective.
 *
 * \param[inout] ccu6 Pointer to the base of CCU6 registers.
 * \param[in]    mode Module suspend mode
 *               Range: \ref IfxCcu6_SuspendMode
 *
 * \retval None
 */
...
/**
 * \brief Returns the base address of the CCU6 module registers corresponding to the given module index.
 *
 * \param[in] ccu6  Pointer to the base of CCU6 registers.
 *
 * \retval Ifx_CCU6* The base address of the CCU6 module registers.
 */
IFX_EXTERN Ifx_CCU6 *IfxCcu6_getAddress(IfxCcu6_Index ccu6);

/**
 * \brief Returns the current value of the capture register for the specified Timer12 capture compare channel.
 *
 * \param[in] ccu6    Pointer to the base of CCU6 registers.
 * \param[in] channel channel Timer12 Capture compare channel number.
 *                    Range: \ref IfxCcu6_T12Channel
 *
 *
 * \retval uint32 Current value of the capture register of the selected channel.
 *                Range: 0 to 0xFFFF.
 */
IFX_EXTERN uint32 IfxCcu6_getCaptureRegisterValue(Ifx_CCU6 *ccu6, IfxCcu6_T12Channel channel);

/**
 * \brief Returns the capture shadow register value of the selected Timer12 channel.
 *
 * \param[in] ccu6     Pointer to the base of CCU6 registers.
 * \param[in] channel  channel Timer12 Capture compare channel number.
 *                     Range: \ref IfxCcu6_T12Channel
 *
 * \retval uint32 Current value of the capture shadow register of the selected channel.
 *                Range: 0 to 0xFFFF.
 */
IFX_EXTERN uint32 IfxCcu6_getCaptureShadowRegisterValue(Ifx_CCU6 *ccu6, IfxCcu6_T12Channel channel);

/**
 * \brief Returns the index of the CCU6 module
 *
 * \param[in] ccu6  Pointer to the base of CCU6 registers.
 *
 * \retval IfxCcu6_Index The index of the CCU6 module.
 *         Range: \ref IfxCcu6_Index.
 *
 */
IFX_EXTERN IfxCcu6_Index IfxCcu6_getIndex(Ifx_CCU6 *ccu6);

/**
 * \brief Returns the service request register for the specified service request output.
 *
 * \param[in] ccu6           Pointer to the base of CCU6 registers.
 * \param[in] serviceRequest Selection of the service request output.
 *                           Range: \ref IfxCcu6_ServiceRequest
 *
 * \retval Ifx_SRC_SRCR* Pointer to the service request register for the specified service request output.
 */
IFX_EXTERN volatile Ifx_SRC_SRCR *IfxCcu6_getSrcAddress(Ifx_CCU6 *ccu6, IfxCcu6_ServiceRequest serviceRequest);

/**
 * \brief Returns the current value of the specified timer register.
 *
 * \param[in] ccu6   Pointer to the base of CCU6 registers.
 * \param[in] timer  Timer selection.
 *                   Range: \ref IfxCcu6_TimerId
 *
 * \retval uint32 Current value of the specified timer register.
 *                Range: 0 to 0xFFFF.
 */
...
/**
 * \brief Clears all interrupt status flags for the CCU6 module.
 *
 * \param[inout] ccu6  Pointer to the base of CCU6 registers.
 *
 * \retval None
...
/**
 * \brief Disables the additional prescaler (1/256) for the specified timer (T12 or T13) to support higher clock frequencies.
 *
 * \param[inout] ccu6   Pointer to the base of CCU6 registers.
 * \param[in]    timer  Timer selection.
 *                      Range: \ref IfxCcu6_TimerId
...
/**
 * \brief Disables the dead time generation for the specified compare channel of Timer12.
 *
 * \param[inout] ccu6     Pointer to the base of CCU6 registers.
 * \param[in]    channel  channel Timer12 Capture compare channel number.
 *                        Range: \ref IfxCcu6_T12Channel
...
/**
 * \brief Disables the delay bypass for the source signal sampling of the Hall input pattern (selected by HSYNC).
 *
 * \param[inout] ccu6  Pointer to the base of CCU6 registers.
 *
 * \retval None
...
/**
 * \brief Disables the selected interrupt source for the CCU6 module.
 *
 * \param[inout] ccu6    Pointer to the base of CCU6 registers.
 * \param[in]    source  Interrupt source selection.
 *                       Range: \ref IfxCcu6_InterruptSource
...
/**
 * \brief Disables multi-channel mode, making write accesses to MCMOUTS ineffective.
 *
 * \param[inout] ccu6  Pointer to the base of CCU6 registers.
 *
 * \retval None
...
/**
 * \brief Disables shadow transfers of the timers (T12, T13 individually or together based on the parameters provided)
 *
 * \param[inout] ccu6 Pointer to the base of CCU6 registers
 * \param[in]    t12  Timer12 selection (true to disable, false to keep enabled)
 * \param[in]    t13  Timer13 selection (true to disable, false to keep enabled)
 *
 * \retval None
 */
...
/**
 * \brief Disables the single shot mode of the specified CCU6 timer (T12 or T13).
 *
 * \param[inout] ccu6   Pointer to the base of CCU6 registers.
 * \param[in]    timer  Timer selection.
 *                      Range: \ref IfxCcu6_TimerId
...
/**
 * \brief Disables the inversion of the T13 signal for modulating CC6x and COUT6x signals.
 *
 * \param[inout] ccu6  Pointer to the base of CCU6 registers.
 *
 * \retval None
...
/**
 * \brief Disables the trap functionality for the specified capture compare output channel.
 *
 * \param[inout] ccu6        Pointer to the base of CCU6 registers.
 * \param[in]    channelOut  Capture compare output channel selection.
 *                           Range: \ref IfxCcu6_ChannelOut
 *
 * \retval None
 */
...
/**
 * \brief Enables the additional prescaler of 1/256 for the specified timer (T12 or T13) to support higher clock frequencies.
 *
 * \param[inout] ccu6   Pointer to the base of CCU6 registers.
 * \param[in]    timer  Timer selection.
 *                      Range: \ref IfxCcu6_TimerId
...
/**
 * \brief Enables or disables the count event for Timer 12 and Timer 13.
 *
 * \param[inout] ccu6  Pointer to the base of CCU6 registers.
 * \param[in]    t12   Timer12 enable flag (TRUE to enable, FALSE to disable).
 * \param[in]    t13   Timer13 enable flag (TRUE to enable, FALSE to disable).
 *
 * \retval None
 */
...
/**
 * \brief Enables the delay bypass for the Hall input pattern sampling using the Dead-Time Counter 0
 *
 * \param[inout] ccu6  Pointer to the base of CCU6 registers.
 *
 * \retval None
...
/**
 * \brief Enables the Hall pattern shadow transfer to immediately update the EXPH and CURH bit fields
 *        using the values from EXPHS and CURHS.
 *
 * \param[inout] ccu6  Pointer to the base of CCU6 registers.
 *
 * \retval None
...
/**
 * \brief Enables the selected interrupt source for the CCU6 module.
 *
 * \param[inout] ccu6    Pointer to the base of CCU6 registers.
 * \param[in]    source  Interrupt source selection.
 *                       Range: \ref IfxCcu6_InterruptSource
...
/**
 * \brief Enables multi-channel mode for the CCU6 module.
 *        This function sets the multi-channel mode and performs a write access to MCMOUTS.
 *
 * \param[inout] ccu6  Pointer to the base of CCU6 registers.
 *
 * \retval None
...
/**
 * \brief Enables the multi-channel PWM pattern shadow transfer by setting the MCM_ST bit to immediately update the MCMP bit field with the value of MCMPS.
 *
 * \param[inout] ccu6  Pointer to the base of CCU6 registers.
 *
 * \retval None
...
/**
 * \brief Enables the shadow transfer T12_ST if the MCMOUT.R flag is set or becomes set during a T12 one-match detection while counting down.
 *
 * \param[inout] ccu6  Pointer to the base of CCU6 registers.
 *
 * \retval None
...
/**
 * \brief Enables the shadow transfer T12_ST if the MCMOUT.R flag is set or becomes set during a T12 period match while counting up.
 *
 * \param[inout] ccu6  Pointer to the base of CCU6 registers.
 *
 * \retval None
...
/**
 * \brief Enables the shadow transfer T13_ST if the MCMOUT.R flag is set or becomes set during a T13 period match.
 *
 * \param[inout] ccu6  Pointer to the base of CCU6 registers.
 *
 * \retval None
...
/**
 * \brief Enables or disables shadow transfers for Timer12 (T12) and Timer13 (T13) individually or together.
 * 
 * \param[inout] ccu6  Pointer to the base of CCU6 registers.
 * \param[in]    t12   Timer12 enable flag (TRUE to enable, FALSE to disable).
 * \param[in]    t13   Timer13 enable flag (TRUE to enable, FALSE to disable).
...
/**
 * \brief Enables the single-shot mode for the specified CCU6 timer (T12 or T13).
 * In single-shot mode, the timer runs once and then stops.
 *
 * \param[inout] ccu6   Pointer to the base of CCU6 registers.
 * \param[in]    timer  Timer selection.
 *                      Range: \ref IfxCcu6_TimerId
...
/**
 * \brief Enables the trap functionality for the specified capture compare output channel.
 *
 * \param[inout] ccu6        Pointer to the base of CCU6 registers.
 * \param[in]    channelOut  Capture compare output channel selection.
 *                           Range: \ref IfxCcu6_ChannelOut
...
/**
 * \brief Configures the input signal selection for the specified capture compare input channel.
 *
 * \param[inout] ccu6    Pointer to the base of CCU6 registers.
 * \param[in]    input   Input selection
 *                       Range: \ref IfxCcu6_CaptureCompareInput
 * \param[in]    signal  selection of actual input signal for the module inputs
 *                       Range: \ref IfxCcu6_CaptureCompareInputSignal
 *
 * \retval None
 */
...
/**
 * \brief Disables the selected CCU6 kernel, shutting down its operation.
 *
 * \param[inout] ccu6  Pointer to the base of CCU6 registers.
 *
 * \retval None
...
/**
 * \brief Enables the selected CCU6 kernel for operation
 *
 * \param[inout] ccu6  Pointer to the base of CCU6 registers.
 *
 * \retval None
...
/**
 * \brief Initialises and configures a CC60 input pin for capture operations.
 *
 * \param[inout] cc60In     Pointer to the CC60 capture input structure to be initialized.
 * \param[in]    inputMode  The input mode to be configured for the pin.
...
/**
 * \brief Initializes and configures a specified CC60 compare output pin with the given output mode and pad driver settings.
 *
 * \param[inout] cc60Out      Pointer to the CC60 compare output structure to be initialized.
 * \param[in]    outputMode   The output mode to be configured for the pin.
...
/**
 * \brief Initializes and configures a CC61 input pin with the specified input mode.
 *
 * \param[inout] cc61In     Pointer to the CC61IN capture input structure to be initialized.
 * \param[in]    inputMode  The input mode to be configured for the pin.
 *                          Range: \ref IfxPort_InputMode
 *
 * \retval None
...
/**
 * \brief Initializes and configures a specified CC61 compare output pin with the given output mode and pad driver settings.
 *
 * \param[inout] cc61Out      Pointer to the CC61 compare output structure to be initialized.
 * \param[in]    outputMode   The output mode to be configured for the pin.
 *                            Range: \ref IfxPort_OutputMode
 * \param[in]    padDriver    The pad driver mode to be configured.
 *                            Range: \ref IfxPort_PadDriver
...
/**
 * \brief Initializes a CC62 input pin with the specified input mode.
 *
 * \param[inout] cc62In     Pointer to the CC62 input configuration structure.
 * \param[in]    inputMode  The input mode to be configured for the pin.
 *                          Range: \ref IfxPort_InputMode
 *
 * \retval None
...
/**
 * \brief Initializes and configures a specified CC62 compare output pin with the given output mode and pad driver settings.
 *
 * \param[inout] cc62Out     Pointer to the CC62 compare output structure to be initialized.
 * \param[in]    outputMode  The output mode to be configured for the pin.
 *                           Range: \ref IfxPort_OutputMode
 * \param[in]    padDriver   The pad driver mode to be configured.
 *                           Range: \ref IfxPort_PadDriver
...
/**
 * \brief Initializes a CCPOS0 input pin for capture functionality.
 *
 * \param[inout] ccpos0     Pointer to the CCPOS0 input configuration structure.
 * \param[in]    inputMode  The input mode to be configured for the pin.
 *                          Range: \ref IfxPort_InputMode
 *
 * \retval None
...
/**
 * \brief Initializes and configures the CCPOS1 input pin according to the specified input mode.
 *
 * \param[inout] ccpos1     Pointer to the CCPOS1 configuration structure.
 * \param[in]    inputMode  The input mode to be configured for the pin.
 *                          Range: \ref IfxPort_InputMode
 *
 * \retval None
...
/**
 * \brief Initialises a CCPOS2 input pin
 *
 * \param[inout] ccpos2     Pointer to the CCPOS2 input configuration structure.
 * \param[in]    inputMode  The input mode to be configured for the pin.
 *                          Range: \ref IfxPort_InputMode
 *
 * \retval None
...
/**
 * \brief Initializes a specified COUT60 output pin
 *
 * \param[inout] cout60      Pointer to the COUT60 output pin to be initialized
 * \param[in]    outputMode  The output mode to be configured for the pin.
 *                           Range: \ref IfxPort_OutputMode
 * \param[in]    padDriver   The pad driver mode to be configured.
 *                           Range: \ref IfxPort_PadDriver
...
/**
 * \brief Initializes and configures a COUT61 output pin with specified output mode and pad driver settings.
 *
 * \param[inout] cout61      Pointer to the COUT61 output configuration structure to be initialized.
 * \param[in]    outputMode  The output mode to be configured for the pin.
 *                           Range: \ref IfxPort_OutputMode
 * \param[in]    padDriver   The pad driver mode to be configured.
 *                           Range: \ref IfxPort_PadDriver
...
/**
 * \brief Initializes and configures a COUT62 output pin with specified output mode and pad driver settings.
 *
 * \param[inout] cout62      Pointer to the COUT62 output configuration structure to be initialized.
 * \param[in]    outputMode  The output mode to be configured for the pin.
 *                           Range: \ref IfxPort_OutputMode
 * \param[in]    padDriver   The pad driver mode to be configured.
 *                           Range: \ref IfxPort_PadDriver
...
/**
 * \brief Initializes and configures a COUT63 output pin with specified output mode and pad driver settings.
 *
 * \param[inout] cout63      Pointer to the COUT63 output configuration structure to be initialized.
 * \param[in]    outputMode  The output mode to be configured for the pin.
 *                           Range: \ref IfxPort_OutputMode
 * \param[in]    padDriver   The pad driver mode to be configured.
 *                           Range: \ref IfxPort_PadDriver
...
/**
 * \brief Initializes a CTRAP input pin with the specified input mode.
 *
 * \param[inout] ctrap      Pointer to the CTRAP input structure to be initialized.
 * \param[in]    inputMode  The input mode to be configured for the pin.
 *                          Range: \ref IfxPort_InputMode
 *
 * \retval None
...
/**
 * \brief Initializes a T12HR input pin with the specified input mode.
 *
 * \param[inout] t12hrIn    Timer 12 HR input configuration structure. Must not be NULL.
 * \param[in]    inputMode  The input mode to be configured for the pin.
 *                          Range: \ref IfxPort_InputMode
 *
 * \retval None
...
/**
 * \brief Initializes a T13HR input pin with the specified input mode.
 *
 * \param[inout] t13hrIn    Pointer to the Timer 13 HR input configuration structure.
 * \param[in]    inputMode  The input mode to be configured for the pin.
 *                          Range: \ref IfxPort_InputMode
 *
 * \retval None
...
/**
 * \brief Initializes the CC60 input pin as input and configures the pad driver.
 *
 * \param[inout] cc60In     Pointer to the CC60 input configuration structure.
 * \param[in]    inputMode  The input mode to be configured for the pin.
 *                          Range: \ref IfxPort_InputMode
 * \param[in]    padDriver  The pad driver mode to be configured.
 *                          Range: \ref IfxPort_PadDriver
...
/**
 * \brief Initializes and configures the CC61 input pin with the specified input mode and pad driver settings.
 *
 * \param[inout] cc61In     Pointer to the CC61 capture input structure to be initialized.
 * \param[in]    inputMode  The input mode to be configured for the pin.
 *                          Range: \ref IfxPort_InputMode
 * \param[in]    padDriver  The pad driver mode to be configured.
 *                          Range: \ref IfxPort_PadDriver
...
/**
 * \brief Initializes the CC62 input pin with the specified input mode and pad driver configuration.
 *
 * This function configures the CC62 input pin as an input and sets the pad driver according to the provided parameters.
 *
 * \param[inout] cc62In     Pointer to the CC62 input configuration structure.
 * \param[in]    inputMode  The input mode to be configured for the pin.
 *                          Range: \ref IfxPort_InputMode
...
/**
 * \brief Initializes the CCPOS0 pin as an input with the specified input mode and pad driver configuration.
 *
 * \param[inout] ccpos0     Pointer to the IfxCcu6_Ccpos0_In structure representing the CCPOS0 input to be configured.
 * \param[in]    inputMode  The input mode to be configured for the pin.
 *                          Range: \ref IfxPort_InputMode
 * \param[in]    padDriver  The pad driver mode to be configured.
 *                          Range: \ref IfxPort_PadDriver
...
/**
 * \brief Initializes the CCPOS1 pin as an input with the specified input mode and pad driver configuration.
 *
 * \param[inout] ccpos1     Pointer to the IfxCcu6_Ccpos1_In structure representing the CCPOS1 input to be configured.
 * \param[in]    inputMode  The input mode to be configured for the pin.
 *                          Range: \ref IfxPort_InputMode
 * \param[in]    padDriver  The pad driver mode to be configured.
 *                          Range: \ref IfxPort_PadDriver
...
/**
 * \brief Initializes the CCPOS2 pin configuration with the specified input mode and pad driver settings.
 *
 * \param[inout] ccpos2     Pointer to the IfxCcu6_Ccpos2_In structure that contains the configuration for the CCPOS2 pin.
 * \param[in]    inputMode  The input mode to be configured for the pin.
 *                          Range: \ref IfxPort_InputMode
 * \param[in]    padDriver  The pad driver mode to be configured.
 *                          Range: \ref IfxPort_PadDriver
...
/**
 * \brief Initializes the CTRAP pin as input and configures the pad driver.
 *
 * \param[inout] ctrap      Pointer to the CTRAP input configuration structure.
 * \param[in]    inputMode  The input mode to be configured for the pin.
 *                          Range: \ref IfxPort_InputMode
 * \param[in]    padDriver  The pad driver mode to be configured.
 *                          Range: \ref IfxPort_PadDriver
...
/**
 * \brief Initializes the T12HR pin as an input with specified input mode and pad driver configuration.
 *
 * \param[inout] t12hrIn    Pointer to the Timer 12 HR input structure to be configured.
 * \param[in]    inputMode  The input mode to be configured for the pin.
 *                          Range: \ref IfxPort_InputMode
 * \param[in]    padDriver  The pad driver mode to be configured.
 *                          Range: \ref IfxPort_PadDriver
...
/**
 * \brief Initializes the T13HR pin as an input and configures its pad driver settings.
 *
 * \param[inout] t13hrIn    Pointer to the Timer 13 HR input configuration structure.
 * \param[in]    inputMode  The input mode to be configured for the pin.
 *                          Range: \ref IfxPort_InputMode
 ...
 * 
 * \param[inout] ccu6  Pointer to the base of CCU6 registers.
 * \param[in]    mode  Mode selection
 *                     Range: \ref IfxCcu6_SleepMode
 * 
 * \retval None
 */
...
/**
 * \brief Resets the CCU6 module to its initial state.
 *
 * \param[inout] ccu6  Pointer to the base of CCU6 registers.
 *
 * \retval None
