 ...
 *
 * \param[inout] timer    Pointer to the IfxCcu6_Timer module handle.
...
/**
 * \brief Initializes Timer13 of the CCU6 module with the provided configuration.
 *
 * \param[in] config Pointer to the configuration structure to be initialized.
 *
 * \retval None
 */
IFX_EXTERN void IfxCcu6_Timer_initTimer13(const IfxCcu6_Timer_Config *config);

/**
 * \brief Initializes Timer12 of the CCU6 module with the provided configuration.
 *
 * \param[inout] config Pointer to the configuration structure to be initialized.
 *
 * \retval None
 */
IFX_EXTERN void IfxCcu6_Timer_initTimer12(const IfxCcu6_Timer_Config *config);

/**
 * \brief Initializes the CCU6 timer pins based on the provided configuration.
 *
 * \param[in] pins Pointer to the configuration structure of type IfxCcu6_Timer_Pins, which contains the pin settings.
 *
 * \retval None
 */
IFX_EXTERN void IfxCcu6_Timer_initPins(const IfxCcu6_Timer_Pins *pins);
 ...
 * \param[in]    interrupt  Configuration structure containing interrupt settings such as enable flags,
 *                          priority configuration, and service request node selection.
 *
 * \retval None
 */
IFX_EXTERN void IfxCcu6_Timer_initInterrupt(Ifx_CCU6 *ccu6, IfxCcu6_Timer_InterruptConfig interrupt);

/**
 * \brief Initializes the Timer module configuration structure with default values.
 *
 * \param[inout] config Pointer to the configuration structure to be initialized.
...
/**
 * \brief Counts one step of the specified CCU6 timer module.
 *
 * \param[in] timer Pointer to the IfxCcu6_Timer module handle.
 *
 * \retval None
 */
...
/**
 * \brief Starts the specified CCU6 timer according to the configuration provided in the module handle.
 *
 * \param[inout] timer Pointer to the IfxCcu6_Timer module handle.
 *
 * \retval None
...
/**
 * \brief Starts the single shot mode of the CCU6 timer.
 *
 * \param[in] timer Pointer to the IfxCcu6_Timer module handle.
 *
 * \retval None
...
/**
 * \brief Stops the specified CCU6 timer.
 *
 * \param[inout] timer Pointer to the IfxCcu6_Timer module handle.
 *
 * \retval None
...
/**
 * \brief Starts both timers synchronously.
 *
 * \param[in] timer Pointer to the IfxCcu6_Timer module handle.
 *
 * \retval None
...
/**
 * \brief Stops both the timers together
 *
 * \param[in] timer Pointer to the IfxCcu6_Timer module handle.
 *
 * \retval None
