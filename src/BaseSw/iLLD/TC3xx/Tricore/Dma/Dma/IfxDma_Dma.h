...
/**
 * \brief Initializes the DMA module configuration structure with the provided DMA registers.
 *
 * \param[inout] config Pointer to the DMA module configuration structure to be initialized.
...
/**
 * \brief Initializes the DMA module channel configuration with default values.
 *
 * \param[inout] config Pointer to the DMA channel configuration structure to be initialized.
 * \param[in]    dma    Pointer to the DMA module handle instance.
 *
 * \retval None
 *
 * \see \ref IfxLld_Dma_Dma_Simple
...
/**
 * \brief Returns the source pointer for the specified DMA channel.
 *
...
/**
 * \brief Initializes a linked list entry for DMA channel configuration.
 *
 * \param[inout] ptrToAddress Pointer to the memory location where the linked list entry will be stored.
 * \param[in]    config       Pointer to the DMA channel configuration structure to be initialized.
 *
 * \retval None
 * 
...
/**
 * \brief Checks and clears the channel transfer interrupt flag.
 *
 * \param[inout] channel Pointer to the DMA base address and channel ID.
 *
...
/**
 * \brief Checks if a transaction request for the specified DMA channel is pending.
 *
 * \param[in] channel Pointer to the DMA base address and channel ID.
 *
...
/**
 * \brief Initiates the DMA move transaction for the specified channel.
 *
 * \param[inout] channel Pointer to the DMA base address and channel ID.
 *
 * \retval None
