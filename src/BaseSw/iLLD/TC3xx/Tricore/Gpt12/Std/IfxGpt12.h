...
/**
 * \brief Returns the address of Timer 2 service request register.
 *
 * \param[in] gpt12 Pointer to the GPT12 module base address.
 *
 * \retval Ifx_SRC_SRCR* Address of Timer 2 service request register.
 *
 */
IFX_INLINE volatile Ifx_SRC_SRCR *IfxGpt12_T2_getSrc(Ifx_GPT12 *gpt12);

/**
 * \brief Returns the address of Timer 3 service request register.
 *
 * \param[in] gpt12 Pointer to the GPT12 module base address.
 *
 * \retval Ifx_SRC_SRCR* Address of Timer 3 service request register.
 *
 */
IFX_INLINE volatile Ifx_SRC_SRCR *IfxGpt12_T3_getSrc(Ifx_GPT12 *gpt12);

/**
 * \brief Returns the address of Timer 4 service request register.
 *
 * \param[in] gpt12 Pointer to the GPT12 module base address.
 *
 * \retval Ifx_SRC_SRCR* Address of Timer 4 service request register.
 *
 */
IFX_INLINE volatile Ifx_SRC_SRCR *IfxGpt12_T4_getSrc(Ifx_GPT12 *gpt12);

/**
 * \brief Returns the address of Timer 5 service request register.
 *
 * \param[in] gpt12 Pointer to the GPT12 module base address.
 *
 * \retval Ifx_SRC_SRCR* Address of Timer 5 service request register.
 *
 */
IFX_INLINE volatile Ifx_SRC_SRCR *IfxGpt12_T5_getSrc(Ifx_GPT12 *gpt12);

/**
 * \brief Returns the address of Timer 6 service request register.
 *
 * \param[in] gpt12 Pointer to the GPT12 module base address.
 * 
 * \retval Ifx_SRC_SRCR* Address of Timer 6 interrupt service request.
 *
 */
IFX_INLINE volatile Ifx_SRC_SRCR *IfxGpt12_T6_getSrc(Ifx_GPT12 *gpt12);

/**
 * \brief Returns the address of the capture service request register for the GPT12 module.
 *
 * \param[in] gpt12 Pointer to the GPT12 module base address.
 *
 * \retval Ifx_SRC_SRCR* Address of the capture interrupt source register.
 *
 */
 ...
 * \param[in]    inputMode The input edge selection mode for capture. Range: \ref IfxGpt12_CaptureInputMode.
 *
 * \retval None
 *
 */
...
/**
 * \brief Configures the input edge selection for the counter mode of the T2 timer.
 *
 * \param[inout] gpt12     Pointer to the GPT12 module base address.
 * \param[in]    inputMode Input edge selection in counter mode. Range: \ref IfxGpt12_CounterInputMode.
 *
 * \retval None
 *
 */
...
/**
 * \brief Sets the T2 timer count direction source to internal or external.
 *
 * \param[inout] gpt12  Pointer to the GPT12 module base address.
 * \param[in]    source Direction source for the timer count direction control. Range: \ref IfxGpt12_TimerDirectionSource.
 *
 * \retval None
 *
 */
...
/**
 * \brief Sets the EUD input for the T2 timer, configuring the input signal selection.
 *
 * \param[inout] gpt12 Pointer to the GPT12 module base address.
 * \param[in]    input The EUD input signal to be selected.  Range: \ref IfxGpt12_EudInput.
 *
 * \retval None
 *
 */
 ...
 *
 * \param[inout] gpt12     Pointer to the GPT12 module base address.
 * \param[in]    inputMode input edge selection in IIM mode. Range: \ref IfxGpt12_IncrementalInterfaceInputMode.
 *
 * \retval None
 *
 */
...
/**
 * \brief Sets the input signal source for the T2 timer.
 *
 * \param[inout] gpt12 Pointer to the GPT12 module base address.
 * \param[in]    input The input signal to be selected. Range: \ref IfxGpt12_Input.
 *
 * \retval None.
 *
 */
...
/**
 * \brief Enables or disables the interrupt generation of the T2 timer.
 *
 * \param[inout] gpt12   Pointer to the GPT12 module base address.
 * \param[in]    enabled Boolean flag to enable (true) or disable (false) the interrupt.
 *
 * \retval None
 *
 */
...
/**
 * \brief Sets the mode of operation for the T2 timer module.
 *
 * \param[inout] gpt12 Pointer to the GPT12 module base address.
 * \param[in]    mode  Selects the operating mode for the T2 timer. Range: \ref IfxGpt12_Mode.
 *
 * \retval None
 *
 */
 ...
 *
 * \param[inout] gpt12     Pointer to the GPT12 module base address.
 * \param[in]    inputMode Input edge selection mode for reload operation. Range: \ref IfxGpt12_ReloadInputMode.
 *
 * \retval None
 *
 */
 ...
 *
 * \param[inout] gpt12   Pointer to the GPT12 module base address.
 * \param[in]    control enable the remote control. Range: \ref IfxGpt12_TimerRemoteControl.
 *
 * \retval None
 *
 */
...
/**
 * \brief Configures the counting direction of the T2 timer.
 *
 * \param[inout] gpt12     Pointer to the GPT12 module base address.
 * \param[in]    direction Specifies the counting direction of the timer. Range: \ref IfxGpt12_TimerDirection.
 *
 * \retval None
 *
 */
 ...
 * 
 * \param[inout] gpt12          Pointer to the GPT12 module base address.
 * \param[in]    inputPrescaler Input prescaler value for Timer mode and Gated Timer mode. Range: \ref IfxGpt12_TimerInputPrescaler.
 *
 * \retval None
 *
 */
...
/**
 * \brief Enables or disables the T3 output signal on the T3OUT pin.
 *
 * \param[inout] gpt12  Pointer to the GPT12 module base address.
 * \param[in]    enable Boolean flag to enable (true) or disable (false) the T3 output.
 *
 * \retval None
 *
 */
...
/**
 * \brief Configures the input edge selection for the counter mode of the T3 timer.
 *
 * \param[inout] gpt12     Pointer to the Ifx_GPT12 module base address.
 * \param[in]    inputMode The input edge selection mode. Range: \ref IfxGpt12_CounterInputMode.
 *
 * \retval None
 *
 */
...
/**
 * \brief Configures the T3 timer count direction source to internal or external.
 *
 * \param[inout] gpt12  Pointer to the Ifx_GPT12 module instance.
 * \param[in]    source The direction source to be set. Range: \ref IfxGpt12_TimerDirectionSource.
 *
 * \retval None
 *
 */
 ...
 *
 * \param[inout] gpt12 Pointer to the GPT12 module base address.
 * \param[in]    input Select the EUD input signal. Range: \ref IfxGpt12_EudInput.
 *
 * \retval None
 *
 */
 ...
 *
 * \param[inout] gpt12     Pointer to the GPT12 module base address.
 * \param[in]    inputMode The input edge selection mode for the incremental interface. Range: \ref IfxGpt12_IncrementalInterfaceInputMode.
 *
 * \retval None
 *
 */
...
/**
 * \brief Sets the mode of operation for T3 timer.
 *
 * \param[inout] gpt12 Pointer to the GPT12 module base address. Range: \ref IfxGpt12_Mode.
 *
 * \retval None
 *
 */
 ...
 * 
 * \param[inout] gpt12     Pointer to the GPT12 module base address.
 * \param[in]    direction Timer direction to be set. Range: \ref IfxGpt12_TimerDirection.
 *
 * \retval None
 *
 */
 ...
 *
 * \param[inout] gpt12          Pointer to the GPT12 module base address.
 * \param[in]    inputPrescaler The input prescaler value to be set. Range: \ref IfxGpt12_TimerInputPrescaler.
 *
 * \retval None
 *
 */
...
/**
 * \brief Enables or disables the clear timer T2 bit of the T4 timer in the GPT12 module.
 *
 * \param[inout] gpt12   Pointer to the GPT12 module base address.
 * \param[in]    enabled Boolean flag to enable (true) or disable (false) the clear timer T2 bit.
 *
 * \retval None
 *
 */
...
/**
 * \brief Enables or disables the clear timer T3 bit of the T4 timer.
 *
 * \param[inout] gpt12   Pointer to the GPT12 module base address.
 * \param[in]    enabled Boolean flag to enable (true) or disable (false) the clear timer T3 bit.
 *
 * \retval None
 *
 */
...
/**
 * \brief Configures the edge detection for the T4 timer's capture mode.
 *
 * \param[inout] gpt12     Pointer to the GPT12 module base address.
 * \param[in]    inputMode The capture input mode to be configured. Range: \ref IfxGpt12_CaptureInputMode.
 *
 * \retval None
 *
 */
 ...
 *
 * \param[inout] gpt12     Pointer to the GPT12 module base address.
 * \param[in]    inputMode Input edge selection mode for the counter. Range: \ref IfxGpt12_CounterInputMode.
 *
 * \retval None
 *
 */
...
/**
 * \brief Sets the T4 timer count direction source to internal or external.
 *
 * \param[inout] gpt12  Pointer to the module base address.
 * \param[in]    source Direction source for the timer count direction. Range: \ref IfxGpt12_TimerDirectionSource.
 *
 * \retval None
 *
 */
 ...
 *
 * \param[inout] gpt12 Pointer to the GPT12 module base address.
 * \param[in]    input Selects the EUD input signal. Range: \ref IfxGpt12_EudInput.
 *
 * \retval None
 *
 */
...
/**
 * \brief Enables or disables the interrupt generation of the T4 timer.
 *
 * \param[inout] gpt12   Pointer to the GPT12 module base address.
 * \param[in]    enabled Boolean flag to enable (TRUE) or disable (FALSE) the interrupt.
 *
...
/** \brief Sets the mode of operation for the T4 timer.
 *
 * \param[inout] gpt12 Pointer to the GPT12 module base address.
 ...
 * 
 * \param[inout] gpt12     Pointer to the GPT12 module base address.
 * \param[in]    inputMode Input edge selection mode for reload. Range: \ref IfxGpt12_ReloadInputMode.
 *
 * \retval None
 *
 */
 ...
 * 
 * \param[inout] gpt12     Pointer to the GPT12 module base address.
 * \param[in]    direction Select the timer direction. Range: \ref IfxGpt12_TimerDirection.
 *
 * \retval None
 *
 */
 ...
 * 
 * \param[inout] gpt12          Pointer to the GPT12 module base address.
 * \param[in]    inputPrescaler input prescaler value in timer mode and gated timer mode. Range: \ref IfxGpt12_TimerInputPrescaler.
 * 
 * \retval None
 *
 */
...
/**
 * \brief Enables or disables the clear timer bit of the T5 timer.
 *
 * \param[inout] gpt12   Pointer to the GPT12 module base address.
 * \param[in]    enabled Boolean value indicating whether to enable (true) or
 *                       disable (false) the clear timer bit.
 *
 * \retval None
 *
 */
...
/**
 * \brief Configures the capture trigger source for the T5 timer.
 *
 * \param[inout] gpt12   Pointer to the GPT12 module base address.
 * \param[in]    trigger Capture trigger. Range: \ref IfxGpt12_CaptureTrigger.
 *
 * \retval None
 *
 */
...
/**
 * \brief Configures the capture trigger enable for the T5 timer.
 *
 * \param[inout] gpt12   Pointer to the GPT12 module base address.
 * \param[in]    enabled Boolean flag to enable (true) or disable (false) the capture trigger.
 *
 * \retval None
 *
 */
 ...
 * 
 * \param[inout] gpt12 Pointer to the GPT12 module base address.
 * \param[in]    mode  The capture trigger mode to be set. Range: \ref IfxGpt12_CaptureTriggerMode.
 *
 * \retval None
 *
 */
...
/**
 * \brief Sets the T5 timer count direction source to internal or external.
 *
 * \param[inout] gpt12  Pointer to the GPT12 module base address.
 * \param[in]    source Direction source for the timer count direction control. Range: \ref IfxGpt12_TimerDirectionSource.
 *
...
/**
 * \brief Sets the input signal for the T5 timer.
 *
 * \param[inout] gpt12 Pointer to the GPT12 module base address.
 * \param[in]    input The input signal to be selected. Range: \ref IfxGpt12_Input.
 *
...
/**
 * \brief Sets the mode of operation for T5 timer.
 *
 * \param[inout] gpt12 Pointer to the GPT12 module base address.
 * \param[in]    mode  Select the mode of operation. Range: \ref IfxGpt12_Mode.
 *
...
/**
 * \brief Sets the remote control state of the T5 timer in the GPT12 module.
 *
 * \param[inout] gpt12   Pointer to the GPT12 module base address.
 * \param[in]    control Enumerated value indicating the remote control state. Range: \ref IfxGpt12_TimerRemoteControl.
 *
 * \retval None
 *
 */
...
/**
 * \brief Configures the counting direction of the T5 timer in the GPT12 module.
 *
 * \param[inout] gpt12     Pointer to the GPT12 module base address.
 * \param[in]    direction select the Timer direction. Range: \ref IfxGpt12_TimerDirection.
 *
 ...
 * 
 * \param[inout] gpt12          Pointer to the GPT12 module base address.
 * \param[in]    inputPrescaler Input prescaler value for the timer. Range: \ref IfxGpt12_TimerInputPrescaler.
 *
 * \retval None
 *
 */
...
/**
 * \brief Enables or disables the clear timer bit of the T6 timer.
 *
 * \param[inout] gpt12   Pointer to the GPT12 module base address.
 * \param[in]    enabled Boolean flag to enable (TRUE) or disable (FALSE) the clear timer.
 *
 * \retval None
 *
 */
...
/**
 * \brief Sets the direction source for the T6 timer count direction.
 *
 * \param[inout] gpt12  Pointer to the GPT12 module base address.
 * \param[in]    source The direction source for the T6 timer. Range: \ref IfxGpt12_TimerDirectionSource.
 *
 * \retval None
 *
 */
...
/**
 * \brief Sets the input source for the T6 timer.
 *
 * \param[inout] gpt12 Pointer to the GPT12 module base address.
 * \param[in]    input The input source selection for the T6 timer. Range: \ref IfxGpt12_Input.
 *
 * \retval None
 *
 */
...
/** \brief Sets the mode of operation for T6 timer.
 *
 * \param[inout] gpt12 Pointer to the GPT12 module base address.
 * \param[in]    mode  Select the mode of operation. Range: \ref IfxGpt12_Mode.
 *
...
/**
 * \brief Sets the T6 timer reload mode.
 *
 * \param[inout] gpt12  Pointer to the GPT12 module base address.
 * \param[in]    mode   Timer reload mode. Range: \ref IfxGpt12_TimerReloadMode.
 *
 * \retval None
 *
 */
...
/**
 * \brief Enables or disables the T6 output on pin T6OUT.
 *
 * \param[inout] gpt12  Pointer to the GPT12 module base address.
 * \param[in]    enable Boolean flag to enable (true) or disable (false) the T6 output.
 *
 * \retval None
 *
 */
IFX_INLINE void IfxGpt12_T6_enableOutput(Ifx_GPT12 *gpt12, boolean enable);

/**
 * \brief Initializes a Capture input pin for GPT12 with specified input mode.
 *
 * \param[inout] capIn     Pointer to the TxIn Pin configuration structure that needs to be initialized.
 *                         This structure contains the necessary fields to configure the Capture input pin.
 * \param[in]    inputMode The input mode to be configured for the Capture pin. Range: \ref IfxPort_InputMode.
 *
 * \retval None
 *
 */
...
/**
 * \brief Configures and initializes the specified GPT12 TxOUT pin as an output.
 *
 * \param[in] txOut      The TxOUT Pin which should be configured. This is a pointer to the TxOUT pin structure to be initialized.
 * \param[in] outputMode The pin output mode which should be configured. Range: \ref IfxPort_OutputMode.
...
/**
 * \brief Sets the capture input for the GPT12 module.
 *
 * \param[inout] gpt12 Pointer to the GPT12 module instance.
 * \param[in]    input Select the capture input signal. Range: \ref IfxGpt12_CaptureInput.
 *
 * \retval None
 *
 */
...
/**
 * \brief Sets the GPT1 block prescaler, which divides the clock source for the GPT1 block.
 *
 * \param[inout] gpt12 Pointer to the GPT12 module base address.
 * \param[in]    bps1 Selects the GPT1 block prescaler value. Range: \ref IfxGpt12_Gpt1BlockPrescaler.
 *
 * \retval None
 *
 */
...
/**
 * \brief Configures the GPT2 block prescaler value.
 *
 * \param[inout] gpt12 Pointer to the GPT12 module base address.
 * \param[in]    bps2  Selects the GPT2 block prescaler value. Range: \ref IfxGpt12_Gpt2BlockPrescaler.
 *
 * \retval None
 *
 */
...
/**
 * \brief Disables the GPT12 module by halting its operation and preparing it for a safe shutdown.
 *
 * \param[inout] gpt12 Pointer to the GPT12 module base address.
 *
 * \retval None
...
/**
 * \brief Enables the GPT12 module's operation.
 *
 * \param[inout] gpt12 Pointer to the GPT12 module base address.
 *
 * \retval None
...
/**
 * \brief Initializes a TxEUDIn input pin with the specified input mode.
 *
 * \param[in] txEudIn   Pointer to the TxEUDIn pin to be configured.
 * \param[in] inputMode The input mode to be set for the TxEUDIn pin. Range: \ref IfxPort_InputMode.
 *
 * \retval None
 *
 */
...
/**
 * \brief Initializes a TxIn input pin with the specified input mode.
 *
 * \param[in] txIn      Pointer to the TxIn pin configuration structure to be initialized.
 * \param[in] inputMode The input mode to be configured for the TxIn pin. Range: \ref IfxPort_InputMode.
 *
 * \retval None
 *
 */
...
/**
 * \brief Returns the current operating mode of the T2 timer.
 *
 * \param[in] gpt12 Pointer to the GPT12 module base address.
 *
 * \retval IfxGpt12_Mode The current mode of operation for the T2 timer. Range: \ref IfxGpt12_Mode.
 *
 */
IFX_INLINE IfxGpt12_Mode IfxGpt12_T2_getMode(Ifx_GPT12 *gpt12);

/**
 * \brief Returns the current timer value of the T2 timer in the GPT12 module.
 *
 * \param[in] gpt12 Pointer to the GPT12 module base address.
 *
 * \retval uint16 The current value of the T2 timer. Range: 0 to 0xFFFF.
 *
 */
IFX_INLINE uint16 IfxGpt12_T2_getTimerValue(Ifx_GPT12 *gpt12);

/**
 * \brief Returns the current operating mode of the T3 timer.
 *
 * \param gpt12 [in] Pointer to the GPT12 module base address.
 *
 * \retval IfxGpt12_Mode The current mode of operation for the T3 timer. Range: \ref IfxGpt12_Mode.
 *
 */
IFX_INLINE IfxGpt12_Mode IfxGpt12_T3_getMode(Ifx_GPT12 *gpt12);

/**
 * \brief Returns the current 16-bit timer value of the T3 timer.
 *
 * \param[in] gpt12 Pointer to the GPT12 module instance.
 *
 * \retval uint16 The current 16-bit value of the T3 timer. Range: 0 to 0xFFFF.
 *
 */
IFX_INLINE uint16 IfxGpt12_T3_getTimerValue(Ifx_GPT12 *gpt12);

/**
 * \brief Returns the state of the Overflow Toggle Latch for the T3 timer.
 * This latch indicates whether an overflow event has occurred since the last time it was cleared.
 *
 * \param[in] gpt12 Pointer to the GPT12 module base address.
 *
...
/**
 * \brief Returns the current operating mode of the T4 timer.
 *
 * \param[in] gpt12 Pointer to the GPT12 module base address.
 *
 * \retval IfxGpt12_Mode The current mode of operation for the T4 timer. Range: \ref IfxGpt12_Mode.
 * 
 */
IFX_INLINE IfxGpt12_Mode IfxGpt12_T4_getMode(Ifx_GPT12 *gpt12);

/**
 * \brief Retrieves the current value of the T4 timer.
 *
...
/**
 * \brief Returns the current operating mode of the T5 timer.
 *
 * \param[in] gpt12 Pointer to the GPT12 module base address.
 *
 * \retval IfxGpt12_Mode The current mode of operation for the T5 timer. Range: \ref IfxGpt12_Mode.
 *
 */
IFX_INLINE IfxGpt12_Mode IfxGpt12_T5_getMode(Ifx_GPT12 *gpt12);

/**
 * \brief Returns the current timer value of the T5 timer.
 *
 * \param[in] gpt12 Pointer to the GPT12 module base address.
 *
 * \retval uint16 The current value of the T5 timer. Range: 0 to 0xFFFF.
 *
 */
IFX_INLINE uint16 IfxGpt12_T5_getTimerValue(Ifx_GPT12 *gpt12);

/**
 * \brief Retrieves the current operating mode of the T6 timer module.
 *
 * \param[in] gpt12 Pointer to the GPT12 module base address.
 *
 * \retval IfxGpt12_Mode The current operating mode of the T6 timer. Range: \ref IfxGpt12_Mode.
 * 
 */
IFX_INLINE IfxGpt12_Mode IfxGpt12_T6_getMode(Ifx_GPT12 *gpt12);

/**
 * \brief Returns the current timer value of the T6 timer.
 *
 * \param[in] gpt12 Pointer to the GPT12 module base address.
 *
 * \retval uint16 The current 16-bit timer value. Range: 0 to 0xFFFF.
 *
 */
IFX_INLINE uint16 IfxGpt12_T6_getTimerValue(Ifx_GPT12 *gpt12);

/**
 * \brief Returns the current state of the Overflow Toggle Latch for the T6 timer.
 *
 * \param[in] gpt12 Pointer to the GPT12 module base address.
 *
 * \retval TRUE If the overflow toggle latch is set.
 *         FALSE If the overflow toggle latch is not set.
 *
 */
IFX_INLINE boolean IfxGpt12_T6_getOverflowToggleLatch(Ifx_GPT12 *gpt12);

/**
 * \brief Retrieves the frequency of the GPT12 module in Hz.
 *
 * \param[in] gpt12 Pointer to the GPT12 module base address.
 *
 * \retval float32 The frequency of the GPT12 module in Hz.
 *
 */
IFX_INLINE float32 IfxGpt12_getModuleFrequency(Ifx_GPT12 *gpt12);

/**
 * \brief Returns the current capture reload value of the GPT12 module.
 *
 * \param[in] gpt12 Pointer to the GPT12 module base address.
 *
 * \retval uint16 The current capture reload value. Range: 0 to 0xFFFF.
 *
 */
IFX_INLINE uint16 IfxGpt12_getCaptureReload(Ifx_GPT12 *gpt12);
...
/**
 * \brief Returns the frequency of the T2 timer in Hz.
 *
 * \param[in] gpt12 Pointer to the GPT12 module base address.
 *
 * \retval float32  The frequency of the T2 timer in Hz (positive value).
 *
 */
IFX_EXTERN float32 IfxGpt12_T2_getFrequency(Ifx_GPT12 *gpt12);

/**
 * \brief Returns the frequency of the T3 timer in Hz.
 *
 * \param[in] gpt12 Pointer to the GPT12 module base address.
 *
 * \retval float32 Frequency of the T3 timer in Hz.
 *
 */
IFX_EXTERN float32 IfxGpt12_T3_getFrequency(Ifx_GPT12 *gpt12);

/**
 * \brief Returns the current frequency value of the T4 timer module.
 *
 * \param[in] gpt12 Pointer to the Ifx_GPT12 module base address.
 *
 * \retval float32 Frequency value of the T4 timer in Hz.
 * 
 */
IFX_EXTERN float32 IfxGpt12_T4_getFrequency(Ifx_GPT12 *gpt12);

/**
 * \brief Returns the frequency of the T5 timer in Hz.
 *
 * \param[in] gpt12 Pointer to the GPT12 module base address.
 *
 * \retval float32 The frequency of the T5 timer in Hz.
 *
 */
IFX_EXTERN float32 IfxGpt12_T5_getFrequency(Ifx_GPT12 *gpt12);

/**
 * \brief Returns the current frequency of the T6 timer in Hz.
 *
 * \param[in] gpt12 Pointer to the GPT12 module base address.
 *
 * \retval float32 The frequency of the T6 timer in Hz.
 *
 */
...
/**
 * \brief Starts or stops the T2 Timer.
 *
 * \param[inout] gpt12    Pointer to the GPT12 module base address.
 * \param[in]    runTimer Start/stop control for Timer 2. Range: \ref IfxGpt12_TimerRun.
 *
 * \retval None
 *
 */
...
/**
 * \brief Sets the timer value for the T2 timer of the GPT12 module.
 *
 * \param[inout] gpt12 Pointer to the GPT12 module base address.
 * \param[in]    value Timer value to be set. Range: 0 to 0xFFFF.
 *
 * \retval None
 *
 */
...
/**
 * \brief Starts or stops the T3 Timer based on the provided control parameter.
 * 
 * \param[inout] gpt12    Pointer to the GPT12 module base address.
 * \param[in]    runTimer Timer control parameter of type IfxGpt12_TimerRun. Range: \ref IfxGpt12_TimerRun.
 *
 * \retval None
 *
 */
...
/**
 * \brief Sets the timer value for the T3 Timer of the GPT12 module.
 *
 * \param[inout] gpt12 Pointer to the GPT12 module base address.
 * \param[in]    value Timer value to be set. Range: 0 to 0xFFFF.
 *
...
/**
 * \brief Sets the Overflow Toggle Latch of the T3 timer.
 * 
 * \param[inout] gpt12 Pointer to the GPT12 module base address.
 * \param[in]    value Boolean value to set or clear the T3OTL:
 *                     - TRUE: Enable the overflow toggle latch
 *                     - FALSE: Disable the overflow toggle latch
 *
 * \retval None
 *
 */
IFX_INLINE void IfxGpt12_T3_setOverflowToggleLatch(Ifx_GPT12 *gpt12, boolean value);

/** \brief Starts / stops the T4 Timer.
 *
 * \param[inout] gpt12    Pointer to the GPT12 module base address.
 * \param[in]    runTimer Start/stop Timer 4. Range: \ref IfxGpt12_TimerRun.
 *
 * \retval None
 *
 */
...
/**
 * \brief Sets the timer value for the T4 timer of the GPT12 module.
 *
 * \param[inout] gpt12 Pointer to the GPT12 module base address.
 * \param[in]    value Timer value to be set. Range: 0 to 0xFFFF.
 *
...
/**
 * \brief Starts or stops the T5 Timer based on the provided control parameter.
 *
 * \param[inout] gpt12    Pointer to the GPT12 module base address.
 * \param[in]    runTimer Enumerated value indicating whether to start or stop the timer. Range: \ref IfxGpt12_TimerRun.
 *
 * \retval None
 *
 */
...
/**
 * \brief Sets the timer value for the T5 timer of the GPT12 module.
 *
 * \param[inout] gpt12 Pointer to the base address of the GPT12 module.
 * \param[in]    value Timer value to be set. Range: 0 to 0xFFFF.
 *
 * \retval None
 *
...
/**
 * \brief Starts or stops the T6 Timer based on the provided control parameter.
 *
 * \param[inout] gpt12    Pointer to the GPT12 module base address.
 * \param[in]    runTimer Enumerated value specifying whether to start or stop the timer. Range: \ref IfxGpt12_TimerRun.
 *
 * \retval None
 *
 */
...
/**
 * \brief Sets the timer value for the T6 timer of the GPT12 module.
 *
 * \param[inout] gpt12 Pointer to the GPT12 module base address.
 * \param[in]    value Timer value to be set. Range: 0 to 0xFFFF.
 *
...
/**
 * \brief Sets the Overflow Toggle Latch of the T6 timer.
 * 
 * \param[inout] gpt12 Pointer to the GPT12 module base address.
 * \param[in]    value Boolean value to set/clear the T6OTL:
 *                     - TRUE: Enable the overflow toggle latch
 *                     - FALSE: Disable the overflow toggle latch
 * 
 * \retval None
 *
 */
IFX_INLINE void IfxGpt12_T6_setOverflowToggleLatch(Ifx_GPT12 *gpt12, boolean value);

/**
 * \brief Configures the capture reload value for the GPT12 module.
 *
 * \param[inout] gpt12 Pointer to the GPT12 module base address.
 * \param[in]    value Reload value to be set. Range: 0 to 0xFFFF.
 *
 * \retval None
 *
 */
IFX_INLINE void IfxGpt12_setCaptureReload(Ifx_GPT12 *gpt12, uint16 value);

/**
 * \brief Sets the sensitivity of the module to sleep signal
 * 
 * \param[inout] gpt12 Pointer to the GPT12 module base address.
 * \param[in]    mode  Mode selection (enable/disable). Range: \ref IfxGpt12_SleepMode.
 * 
 * \retval None
 *
 */
 ...
 *
 * \param[inout] gpt12 Pointer to the GPT12 module base address.
 * \param[in]    mode  The suspend mode to be set. Range: \ref IfxGpt12_SuspendMode.
 *
 * \note The API works only when OCDS is enabled and in Supervisor Mode. When OCDS
 * is disabled, the OCS suspend control is ineffective.
 *
 * \retval None
 *
 */
...
/**
 * \brief Resets the GPT12 kernel module to its initial state.
 *
 * \param[inout] Pointer to the GPT12 module base address.
 *
 * \retval None
 *
 */
...
/**
 * \brief Initializes the CAPIN pin as an input with specified input mode and pad driver settings.
 *
 * \param[in] capIn     Pointer to the TxIn Pin configuration structure to be initialized.
 * \param[in] inputMode The input mode to be configured for the CAPIN pin (e.g., pull-up, pull-down, etc.).
 *                      Range: \ref IfxPort_InputMode.
 * \param[in] padDriver The pad driver mode to be configured for the CAPIN pin (e.g., normal, high-drive, etc.).
...
/**
 * \brief Checks if the GPT12 module is in a suspended state.
 *
 * \param[in] gpt12 Pointer to the GPT12 module base address.
 *
...
/**
 * \brief Initializes and configures the TXEUD input pin with the specified input mode and pad driver settings.
 *
 * \param[in] txEudIn   The TxEUD_IN pin to be configured. This is a pointer to the pin structure.
 * \param[in] inputMode The input mode to be set for the TXEUD pin. This should be a valid value from the IfxPort_InputMode enumeration.
 *                      Range: \ref IfxPort_InputMode.
 * \param[in] padDriver The pad driver mode to be configured. This should be a valid value from the IfxPort_PadDriver enumeration.
 *                      Range: \ref IfxPort_PadDriver.
 *
 * \retval None
 *
...
/**
 * \brief Initializes the TXIN pin as an input and configures the pad driver.
 * 
 * \param[in] txIn      Pointer to the TXIN pin configuration structure to be initialized.
 *                      This structure represents the TXIN pin that needs to be configured.
 * \param[in] inputMode The input mode to be configured for the TXIN pin. This is an
 *                      enumeration of type IfxPort_InputMode, which defines the input
 *                      characteristics of the pin (e.g., pull-up, pull-down, etc.). Range: \ref IfxPort_InputMode.
 * \param[in] padDriver The pad driver mode to be configured for the TXIN pin. This is
 *                      an enumeration of type IfxPort_PadDriver, which defines the
 *                      driving strength of the pin (e.g., nolrmal, high, etc.). Range: \ref IfxPort_PadDriver.
 *
 * \retval None
 * 
 */
...
boolean IfxGpt12_T3_getOverflowToggleLatch(Ifx_GPT12 *gpt12)
{
	return (boolean)gpt12->T3CON.B.T3OTL;
}
...
void IfxGpt12_T3_setOverflowToggleLatch(Ifx_GPT12 *gpt12, boolean value)
{
	gpt12->T3CON.B.T3OTL = value;
}
...
boolean IfxGpt12_T6_getOverflowToggleLatch(Ifx_GPT12 *gpt12)
{
	return (boolean)gpt12->T6CON.B.T6OTL;
}
...
void IfxGpt12_T6_setOverflowToggleLatch(Ifx_GPT12 *gpt12, boolean value)
{
	gpt12->T6CON.B.T6OTL = value;
}
...
IFX_INLINE uint16 IfxGpt12_getCaptureReload(Ifx_GPT12 *gpt12)
{
   return (uint16)gpt12->CAPREL.B.CAPREL;
}
