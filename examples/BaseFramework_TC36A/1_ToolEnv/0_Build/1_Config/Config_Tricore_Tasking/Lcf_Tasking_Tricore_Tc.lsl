...
#define LCF_INTVEC1_START 0x804FE000
...
derivative tc36
{
    ...
    memory dsram1 // Data Scratch Pad Ram
    {
        ...
        size = 192k;
        type = ram;
        map (dest=bus:tc1:fpi_bus, dest_offset=0xd0000000, size=192k, priority=8);
        map (dest=bus:sri, dest_offset=0x60000000, size=192k);
    }
