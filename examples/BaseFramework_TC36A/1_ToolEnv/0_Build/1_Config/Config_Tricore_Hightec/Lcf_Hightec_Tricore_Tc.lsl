...
__TRICORE_DERIVATE_MEMORY_MAP__ = 0x360;
...
MEMORY
{
    ...
    dsram1_local (w!x): org = 0xd0000000, len = 192K
    dsram1 (w!x): org = 0x60000000, len = 192K
    psram1 (w!x): org = 0x60100000, len = 32K
    
    dsram0_local (w!x): org = 0xd0000000, len = 192K
    dsram0 (w!x): org = 0x70000000, len = 192K
    psram0 (w!x): org = 0x70100000, len = 32K
    
    psram_local (w!x): org = 0xc0000000, len = 32K
    
    pfls0 (rx): org = 0x80000000, len = 2M
    pfls0_nc (rx): org = 0xa0000000, len = 2M
    
    pfls1 (rx): org = 0x80300000, len = 2M
    pfls1_nc (rx): org = 0xa0300000, len = 2M
    
    dfls0 (rx): org = 0xaf000000, len = 128K
