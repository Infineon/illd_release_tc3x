...
MEMORY
{ 
    dsram1: ORIGIN=0x60000000, LENGTH=192K
    psram1: ORIGIN=0x60100000, LENGTH=32K
    
    dsram0: ORIGIN=0x70000000, LENGTH=192K
    psram0: ORIGIN=0x70100000, LENGTH=32K
    
    psram_local: ORIGIN=0xc0000000, LENGTH=32K
    dsram_local: ORIGIN=0xd0000000, LENGTH=96K
    
    pfls0: ORIGIN=0x80000000, LENGTH=2M
    pfls0_nc: ORIGIN=0xa0000000, LENGTH=2M
    
    pfls1: ORIGIN=0x80300000, LENGTH=2M
    pfls1_nc: ORIGIN=0xa0300000, LENGTH=2M
...
SECTIONS
{
    ...
    /* Fixed memory Allocations for _START  for CPU1 */
