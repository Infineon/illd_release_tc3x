...
#define DEVICE_TC33XED			1

#define IFX_PIN_PACKAGE_516		1 /**< Pin package supported: IFX_PIN_PACKAGE_516, IFX_PIN_PACKAGE_LFBGA180_ADAS,
								   * IFX_PIN_PACKAGE_LFBGA292_ADAS
								   */
