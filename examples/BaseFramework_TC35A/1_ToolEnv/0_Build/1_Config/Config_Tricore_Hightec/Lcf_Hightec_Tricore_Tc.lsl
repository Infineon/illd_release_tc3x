...
__TRICORE_DERIVATE_MEMORY_MAP__ = 0x350;
...
MEMORY
{
    ...
    lmuram (w!x): org = 0x90040000, len = 512K
    lmuram_nc (w!x): org = 0xb0040000, len = 512K
...
REGION_ALIAS( inttab2_mem , pfls1)
...
*/
    ...
    SECTIONS
    {
        ...
        .start_tc2 (LCF_STARTPTR_NC_CPU2) : { KEEP (*(.start_cpu2)); } > pfls1_nc
