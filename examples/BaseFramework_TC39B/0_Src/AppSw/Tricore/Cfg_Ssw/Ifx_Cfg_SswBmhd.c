...
{
    0x00FF,         /**< \brief 0x000: .bmi: Boot Mode Index (BMI)*/
    0xB359,         /**< \brief 0x002: .bmhdid: Boot Mode Header ID (CODE) = B359H*/
    0xA0000000,     /**< \brief 0x004: .stad: User Code start address*/
    0x0C197CC0,     /**< \brief 0x008: .crc: Check Result for the BMI Header (offset 000H - 007H)*/
    0xF3E6833F,     /**< \brief 0x00C: .crcInv: Inverted Check Result for the BMI Header (offset 000H - 007H)*/
    {
